local internalNpcName = "Tesoureiro Kardan"
local npcType = Game.createNpcType(internalNpcName)
local npcConfig = {}

npcConfig.name = internalNpcName
npcConfig.description = "Bank NPC - Tesoureiro Kardan"
...
npcHandler:setMessage(MESSAGE_GREET, "Welcome to the Tesoureiro Kardan! How can I help you?")
