local internalNpcName = "Tesoureiro Balthor"
local npcType = Game.createNpcType(internalNpcName)
local npcConfig = {}

npcConfig.name = internalNpcName
npcConfig.description = "Bank NPC - Tesoureiro Balthor"
...
npcHandler:setMessage(MESSAGE_GREET, "Welcome to the Tesoureiro Balthor! How can I help you?")
