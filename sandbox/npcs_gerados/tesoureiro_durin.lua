local internalNpcName = "Tesoureiro Durin"
local npcType = Game.createNpcType(internalNpcName)
local npcConfig = {}

npcConfig.name = internalNpcName
npcConfig.description = "Bank NPC - Tesoureiro Durin"
...
npcHandler:setMessage(MESSAGE_GREET, "Welcome to the {bank_name}! How can I help you?")
