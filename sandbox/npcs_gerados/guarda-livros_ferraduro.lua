local internalNpcName = "Guarda-Livros Ferraduro"
local npcType = Game.createNpcType(internalNpcName)
local npcConfig = {}

npcConfig.name = internalNpcName
npcConfig.description = "Bank NPC - Guarda-Livros Ferraduro"
...
npcHandler:setMessage(MESSAGE_GREET, "Welcome to the Guarda-Livros Ferraduro! How can I help you?")
