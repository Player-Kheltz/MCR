...
print(f'Resolvidos: {sum(1 for v in res.values() if v)}/{len(res)}')
# Verificar compilacao novamente
p2 = de.check_compilacao()
print(f'Erros de compilacao apos reparo: {len(p2)}')
