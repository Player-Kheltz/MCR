--[[
    Projeto MCR ? postura_config.lua (v2.0)
    Configurações de posturas de combate.
    Separado para manter a modularidade.
--]]
...
POSTURA_BASE = {
    ...
    [WEAPON_AXE] = {
        [1] = { speedMod=1.05, damageMod=1.20, effects={type=CONDITION_BLEEDING, chance=20, duration=4000, damage=5} },
        [2] = { speedMod=1.00, damageMod=1.00 },
        [3] = { speedMod=1.10, damageMod=0.65, damageTakenMod=0.80, healthRegenMod=1.4 }
    },
    [WEAPON_CLUB] = {
        [1] = { speedMod=1.05, damageMod=1.10, effects={type=CONDITION_DAZZLED, chance=15, duration=2000} },
        [2] = { speedMod=1.00, damageMod=1.00 },
    ...
    [WEAPON_MISSILE] = {
        [1] = { speedMod=0.85, damageMod=1.05, ricocheteChance=25 },
...
ARREMESSO_SEM_ESCUDO = { speedMod=0.80, ricocheteChance=20 }
...
function corDominio(domId)
    local cores = {
        ...
        [30] = COR.DOM_OFICIO_CRAFT, [31] = COR.DOM_OFICIO_MINERACAO, [32] = COR.DOM_OFICIO_PESCA,
        [40] = COR.DOM_NATUREZA_CULTIVO, [41] = COR.DOM_NATUREZA_CULTIVO, [42] = COR.DOM_NATUREZA_RASTREAM, [43] = COR.DOM_NATUREZA_SOBREV,
        [400] = COR.DOM_NATUREZA_SOBREV,
    }
    return cores[domId] or COR.SISTEMA_INFO
end

print("DEBUG: postura_config.lua (v2.0) carregado.")