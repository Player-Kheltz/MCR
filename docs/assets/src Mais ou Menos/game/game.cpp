...
namespace InternalGame {
	...
	T getCustomAttributeValue(const auto item, const std::string &attributeName) {
		...
		if (value < std::numeric_limits<T>::min() || value > std::numeric_limits<T>::max()) {
			g_logger().error("O valor [{}] est\341 fora do intervalo para o tipo especificado", __FUNCTION__);
			return 0;
		}
...
Game::Game() {
	[[maybe_unused]] auto &[choices1_text, choices1_value] = offlineTrainingWindow.choices.emplace_back("Luta e Blindagem", SKILL_FIST);
	[[maybe_unused]] auto &[choices2_text, choices2_value] = offlineTrainingWindow.choices.emplace_back("Luta de Espada e Blindagem", SKILL_SWORD);
	[[maybe_unused]] auto &[choices3_text, choices3_value] = offlineTrainingWindow.choices.emplace_back("Luta e blindagem com machado", SKILL_AXE);
	[[maybe_unused]] auto &[choices4_text, choices4_value] = offlineTrainingWindow.choices.emplace_back("Luta e blindagem de clube", SKILL_CLUB);
	[[maybe_unused]] auto &[choices5_text, choices5_value] = offlineTrainingWindow.choices.emplace_back("Combate \340 Dist\342ncia e Blindagem", SKILL_DISTANCE);
	[[maybe_unused]] auto &[choices6_text, choices6_value] = offlineTrainingWindow.choices.emplace_back("N\355vel M\341gico e Blindagem", SKILL_MAGLEVEL);
	...
	m_badges = {
		Badge(1, ACCOUNT_AGE, "Rookie Hero", 1),
		...
		Badge(6, LOYALTY, "Lealista do Tibia (Grau 1)", 100),
		Badge(7, LOYALTY, "Lealista do Tibia (Grau 2)", 1000),
		Badge(8, LOYALTY, "Lealista do Tibia (Grau 3)", 5000),

		Badge(9, ACCOUNT_ALL_LEVEL, "Jogador Global (Grau 1)", 500),
		Badge(10, ACCOUNT_ALL_LEVEL, "Jogador Global (Grau 2)", 1000),
		Badge(11, ACCOUNT_ALL_LEVEL, "Jogador Global (Grau 3)", 2000),

		Badge(12, ACCOUNT_ALL_VOCATIONS, "Aula mestre (1\252 s\351rie)", 100),
		Badge(13, ACCOUNT_ALL_VOCATIONS, "Aula mestre (2\252 s\351rie)", 250),
		Badge(14, ACCOUNT_ALL_VOCATIONS, "Aula mestre (3\252 s\351rie)", 500),

		Badge(15, TOURNAMENT_PARTICIPATION, "Calouro do Torneio", 1),
		Badge(16, TOURNAMENT_PARTICIPATION, "Regular do Torneio", 5),
		Badge(17, TOURNAMENT_PARTICIPATION, "Her\363i do Torneio", 10),

		Badge(18, TOURNAMENT_POINTS, "Competidor do Torneio", 1000),
		Badge(19, TOURNAMENT_POINTS, "Desafiador do Torneio", 2500),
		Badge(20, TOURNAMENT_POINTS, "Mestre do Torneio", 5000),
		Badge(21, TOURNAMENT_POINTS, "Campe\343o do Torneio", 10000),
	};

	m_titles = {
		Title(1, GOLD, "Acumulador de ouro", "Ganhou pelo menos 1.000.000 de ouro.", 1000000, false),
		Title(2, GOLD, "Acumulador de Platina", "Ganhou pelo menos 10.000.000 de ouro.", 10000000, false),
		Title(3, GOLD, "Acumulador de Cristal", "Ganhou pelo menos 100 milh\365es de ouro.", 100000000, false),

		Title(4, MOUNTS, "Beaststrider (Grade 1)", "Desbloqueou 10 ou mais montarias.", 10, true),
		Title(5, MOUNTS, "Beaststrider (Grade 2)", "Desbloqueou 20 ou mais montarias.", 20, true),
		Title(6, MOUNTS, "Beaststrider (Grade 3)", "Desbloqueou 30 ou mais montarias.", 30, true),
		Title(7, MOUNTS, "Beaststrider (Grade 4)", "Desbloqueou 40 ou mais montarias.", 40, true),
		Title(8, MOUNTS, "Beaststrider (Grade 5)", "Desbloqueou 50 ou mais montarias.", 50, true),

		Title(9, OUTFITS, "Topmodel of Tibia (Grade 1)", "Desbloqueou 10 ou mais trajes.", 10, true),
		Title(10, OUTFITS, "Topmodel of Tibia (Grade 2)", "Desbloqueou 20 ou mais trajes.", 20, true),
		Title(11, OUTFITS, "Topmodel of Tibia (Grade 3)", "Desbloqueou 30 ou mais trajes.", 30, true),
		Title(12, OUTFITS, "Topmodel of Tibia (Grade 4)", "Desbloqueou 40 ou mais trajes.", 40, true),
		Title(13, OUTFITS, "Topmodel of Tibia (Grade 5)", "Desbloqueou 50 ou mais trajes.", 50, true),
		...
		Title(21, HIGHSCORES, "Apex Predator", "", "N\355vel mais alto n\343o mundo do personagem.", static_cast<uint8_t>(EXPERIENCE)),
		Title(22, HIGHSCORES, "Big Boss", "", "Maior pontua\347\343o acumulada de pontos de chefe n\343o mundo do personagem.", static_cast<uint8_t>(BOSS_POINTS)),
		Title(23, HIGHSCORES, "Jack of All Pests", "", "Maior pontua\347\343o por matar Goshnar e seus aspectos n\343o mundo do personagem.", static_cast<uint8_t>(GOSHNAR)),
		Title(24, HIGHSCORES, "Legend of Fishing", "", "Maior n\355vel de pesca n\343o mundo do personagem.", static_cast<uint8_t>(FISHING)),
		Title(25, HIGHSCORES, "Legend of Magic", "", "N\355vel m\341gico mais alto n\343o mundo do personagem.", static_cast<uint8_t>(MAGIC_LEVEL)),
		Title(26, HIGHSCORES, "Legend of Marksmanship", "", "Maior n\355vel de dist\342ncia n\343o mundo do personagem.", static_cast<uint8_t>(DISTANCE_FIGHTING)),
		Title(27, HIGHSCORES, "Legend of the Axe", "", "N\355vel de machado mais alto n\343o mundo do personagem.", static_cast<uint8_t>(AXE_FIGHTING)),
		Title(28, HIGHSCORES, "Legend of the Club", "", "N\355vel de clube mais alto n\343o mundo do personagem.", static_cast<uint8_t>(CLUB_FIGHTING)),
		Title(29, HIGHSCORES, "Legend of the Fist", "", "N\355vel de punho mais alto n\343o mundo do personagem.", static_cast<uint8_t>(FIST_FIGHTING)),
		Title(30, HIGHSCORES, "Legend of the Shield", "", "Maior n\355vel de blindagem n\343o mundo do personagem.", static_cast<uint8_t>(SHIELDING)),
		Title(31, HIGHSCORES, "Legend of the Sword", "", "N\355vel de espada mais alto n\343o mundo do personagem.", static_cast<uint8_t>(SWORD_FIGHTING)),
		Title(32, HIGHSCORES, "Prince Charming", "Princesa Encantada", "Maior pontua\347\343o acumulada de pontos de charme n\343o mundo do personagem.", static_cast<uint8_t>(CHARMS)),
		Title(33, HIGHSCORES, "Current Drome Champion", "", "Terminou a rota mais recente do Tibiadrome classificada entre os 5 primeiros.", static_cast<uint8_t>(DROME)),

		Title(34, BESTIARY, static_cast<uint16_t>(BESTY_RACE_HUMANOID), "Bipedantic", "", "Unlocked all Humanoid Bestiary entries."),
		Title(35, BESTIARY, static_cast<uint16_t>(BESTY_RACE_LYCANTHROPE), "Blood Moon Hunter", "Ca\347adora da Lua Sangrenta", "Todas as entradas do Besti\341rio do Lycanthrope foram desbloqueadas."),
		Title(36, BESTIARY, static_cast<uint16_t>(BESTY_RACE_AMPHIBIC), "Coldblooded", "", "Unlocked all Amphibian Bestiary entries."),
		...
		Title(42, BESTIARY, static_cast<uint16_t>(BESTY_RACE_FEY), "Mata-fadas", "", "Desbloqueou todas as entradas do Besti\341rio Fey."),
		...
		Title(46, BESTIARY, static_cast<uint16_t>(BESTY_RACE_EXTRA_DIMENSIONAL), "Interdimensional Destroyer", "", "Desbloqueou todas as entradas do Besti\341rio Extra Dimensional."),
		Title(47, BESTIARY, static_cast<uint16_t>(BESTY_RACE_HUMAN), "Manhunter", "Manhuntress", "Unlocked all Human Bestiary entries."),
		Title(48, BESTIARY, static_cast<uint16_t>(BESTY_RACE_MAGICAL), "Master of Illusion", "Senhora da Ilus\343o", "Desbloqueou todas as entradas do Besti\341rio M\341gico."),
		Title(49, BESTIARY, static_cast<uint16_t>(BESTY_RACE_SLIME), "Blue Ooze", "", "Desbloqueou todas as entradas do Besti\341rio de Slime."),
		Title(50, BESTIARY, static_cast<uint16_t>(BESTY_RACE_AQUATIC), "Sea Curse", "", "Desbloqueou todas as entradas do Besti\341rio Aqu\341tico."),
		Title(51, BESTIARY, static_cast<uint16_t>(BESTY_RACE_REPTILE), "Snake Charmer", "", "Desbloqueou todas as entradas do Besti\341rio de R\351pteis."),
		...
		Title(55, BOSSTIARY, static_cast<uint16_t>(BosstiaryRarity_t::RARITY_NEMESIS), "Boss Annihilator", "", "Desbloqueou todos os chefes Nemesis.", 0, false),
		Title(56, BOSSTIARY, static_cast<uint16_t>(BosstiaryRarity_t::RARITY_ARCHFOE), "Boss Destroyer", "", "Desbloqueou 10 ou mais chefes Arquiinimigos.", 10, true),
		Title(57, BOSSTIARY, static_cast<uint16_t>(BosstiaryRarity_t::RARITY_NEMESIS), "Boss Devastator", "", "Desbloqueou 10 ou mais chefes Nemesis.", 10, true),
		Title(58, BOSSTIARY, static_cast<uint16_t>(BosstiaryRarity_t::RARITY_ARCHFOE), "Boss Eraser", "", "Desbloqueou todos os chefes Archfoe.", 0, false),
		Title(59, BOSSTIARY, 0, "Boss Executioner", "", "Desbloqueou todos os chefes.", 0, false),
		Title(60, BOSSTIARY, static_cast<uint16_t>(BosstiaryRarity_t::RARITY_BANE), "Boss Hunter", "", "Desbloqueou 10 ou mais chefes Bane.", 10, true),
		Title(61, BOSSTIARY, static_cast<uint16_t>(BosstiaryRarity_t::RARITY_NEMESIS), "Boss Obliterator", "", "Desbloqueou 40 ou mais chefes Nemesis.", 40, true),
		Title(62, BOSSTIARY, static_cast<uint16_t>(BosstiaryRarity_t::RARITY_BANE), "Boss Slayer", "", "Desbloqueou todos os chefes Bane.", 0, false),
		Title(63, BOSSTIARY, static_cast<uint16_t>(BosstiaryRarity_t::RARITY_ARCHFOE), "Boss Smiter", "", "Desbloqueou 40 ou mais chefes Arquiinimigos.", 40, true),
		Title(64, BOSSTIARY, static_cast<uint16_t>(BosstiaryRarity_t::RARITY_BANE), "Boss Veteran", "", "Desbloqueou 40 ou mais chefes Bane.", 40, true),

		Title(65, DAILY_REWARD, "Creature of Habit (Grade 1)", "Sequ\352ncia de recompensas de pelo menos 7 dias de logins consecutivos.", 7, true),
		Title(66, DAILY_REWARD, "Creature of Habit (Grade 2)", "S\351rie de recompensas de pelo menos 30 dias de logins consecutivos.", 30, true),
		Title(67, DAILY_REWARD, "Creature of Habit (Grade 3)", "Sequ\352ncia de recompensas de pelo menos 90 dias de logins consecutivos.", 90, true),
		Title(68, DAILY_REWARD, "Creature of Habit (Grade 4)", "Sequ\352ncia de recompensas de pelo menos 180 dias de logins consecutivos.", 180, true),
		Title(69, DAILY_REWARD, "Creature of Habit (Grade 5)", "Sequ\352ncia de recompensas de pelo menos 365 dias de logins consecutivos.", 365, true),

		Title(70, TASK, "Aspirant Hunter", "Investiu 160.000 pontos de tarefas.", 160000, true, "Aspirante a Ca\347adora"),
		Title(71, TASK, "Competent Beast Slayer", "Investiu 320.000 pontos de tarefas.", 320000, true),
		Title(72, TASK, "Feared Bounty Hunter", "Investiu 430.000 pontos de tarefas.", 430000, true),

		Title(73, MAP, "Dedicated Entrepreneur", "Explorou 50% de todas as \341reas do mapa.", 50, false),
		Title(74, MAP, "Globetrotter", "Explored all map areas.", 100, false),

		Title(75, OTHERS, "Guild Leader", "Liderando uma Guilda.", false),
		Title(76, OTHERS, "Proconsul of Iksupan", "Somente um verdadeiro devoto da causa dos antigos Iks e de seu legado perdido pode ascender ao posto de proc\364nsul.", true),
		Title(77, OTHERS, "Admirer of the Crown", "Ajuste sua coroa e manuseie-a.", true),
		Title(78, OTHERS, "Big Spender", "Desbloqueou o traje dourado completo.", true),
		Title(79, OTHERS, "Challenger of the Iks", "Desafiou Ahau, guardi\343o de Iksupan, em traje tradicional de guerreiro Iks.", true),
		Title(80, OTHERS, "Royal Bounacean Advisor", "Chamado \340 corte de Bounac pelo pr\363prio Kesar, o Jovem.", true),
		Title(81, OTHERS, "Aeternal", "Aeternal", true),
		Title(82, OTHERS, "Robinson Crusoe", "Algumas descobertas s\343o reservadas apenas aos aventureiros mais experientes. At\351 que a pr\363xima fronteira se abra n\343o horizonte.", true),
		Title(83, OTHERS, "Chompmeister", "Chompmeister", true),
		Title(84, OTHERS, "Bringer of Rain", "Avan\347ando batalha ap\363s batalha como um verdadeiro gladiador.", true),
		Title(85, OTHERS, "Beastly", "Beastly", true),
		Title(86, OTHERS, "Midnight Hunter", "Quando o ca\347ador se torna ca\347ado, a perseveran\347a decide o jogo.", true),
		Title(87, OTHERS, "Ratinator", "Ratinator", true),
		Title(88, OTHERS, "Doomsday Nemesis", "Concedido por grande ajuda na batalha contra Gaz'haragoth.", true),
		Title(89, OTHERS, "Hero of Bounac", "Voc\352 prevaleceu durante a batalha de Bounac e quebrou o cerco que mantinha o povo de Bounac sob seu controle firme.", true), // Derrotar o boss Drume.
		Title(90, OTHERS, "King of Demon", "Derrote Morshabaal 5 vezes.", 0, true, "Rainha do Dem\364nio"),
		Title(91, OTHERS, "Planegazer", "Planegazer", true), // Derrotar o boss Planestrider
		Title(92, OTHERS, "Time Traveller", "Em qualquer lugar n\343o tempo ou n\343o espa\347o.", true), // Derrotar o boss Lord Retro
		Title(93, OTHERS, "Truly Boss", "Alcance 15.000 pontos de chefe.", true),
	};
...
void Game::loadBoostedCreature() {
	...
	if (!result) {
		g_logger().warn("[Game::loadBoostedCreature] - "
		                "Falha ao detectar banco de dados de criaturas aprimorado. (C\323DIGO 01)");
		return;
	}
	...
	if (selectedMonster.raceId == 0) {
		g_logger().warn("[Game::loadBoostedCreature] - "
		                "Não foi possível gerar uma nova Criatura Fortalecida->");
		return;
	}
	...
	if (!monsterType) {
		g_logger().warn("[Game::loadBoostedCreature] - "
		                "Não foi possível gerar uma nova Criatura Fortalecida-> Monstro '{}' n\343o encontrado.",
	...
	if (!db.executeQuery(query)) {
		g_logger().warn("[Game::loadBoostedCreature] - "
		                "Falha ao detectar banco de dados de criaturas aprimorado. (C\323DIGO 02)");
	}
}
...
void Game::start(ServiceManager* manager) {
	...
	[[maybe_unused]] auto eventId6 = g_dispatcher().cycleEvent(
		EVENT_LUA_GARBAGE_COLLECTION, [this] { g_luaEnvironment().collectGarbage(); }, "Chamando o GC"
	);
...
void Game::loadMainMap(const std::string &filename) {
    ...
    // ═══ Carregar o mapa cognitivo ═══
    g_logger().info("[MCR-COGNI] Mapa principal carregado. A tentar ler o mapa cognitivo...");
    g_globalMonsterMap().loadFromFile("data/world/global_monster_map.bin");
    g_globalMonsterMap().validateTransitions();
    g_logger().info("[MCR-COGNI] Mapa cognitivo pronto. Total de tiles: {}",
        g_globalMonsterMap().getTiles().size());
}
...
void Game::loadCustomMaps(const std::filesystem::path &customMapPath) {
    ...
    if (!fs::exists(customMapPath) && !fs::create_directory(customMapPath)) {
        throw std::ios_base::failure(fmt::format("Falha ao criar diret\363rio de mapa personalizado {}", customMapPath.string()));
    }
    ...
    for (const auto &entry : fs::directory_iterator(customMapPath)) {
        ...
        if (customMapIndex >= 50) {
            g_logger().warn("N\372mero m\341ximo de mapas personalizados carregados. Mapa personalizado {} [ignorado]", filename);
            continue;
        }

        // Filenames that start with a # are ignored.
        if (filename.at(0) == '#') {
            g_logger().info("Mapa personalizado {} [desativado]", filename);
            continue;
        }

        // Avoid loading main map again.
        if (filename == g_configManager().getString(MAP_NAME)) {
            g_logger().warn("Mapa personalizado {} \351 o mapa principal", filename);
            continue;
        }
    ...
    // ═══ Tentar carregar o mapa cognitivo, caso ainda não tenha sido carregado ═══
    // (Isto é útil se o mapa principal não existir, mas só mapas personalizados.)
    if (g_globalMonsterMap().getTiles().empty()) {
        g_logger().info("[MCR-COGNI] Mapas personalizados carregados. A tentar ler o mapa cognitivo...");
        g_globalMonsterMap().loadFromFile("data/world/global_monster_map.bin");
        g_globalMonsterMap().validateTransitions();
        g_logger().info("[MCR-COGNI] Mapa cognitivo pronto. Total de tiles: {}",
            g_globalMonsterMap().getTiles().size());
...
void Game::loadMap(const std::string &path, const Position &pos) {
    ...
    // Carregar o mapa cognitivo e validar integridade
    g_globalMonsterMap().loadFromFile("data/world/global_monster_map.bin");
    g_globalMonsterMap().validateTransitions();
}
...
std::shared_ptr<Creature> Game::getCreatureByID(uint32_t id) {
	if (id >= Player::getFirstID() && id <= Player::getLastID()) {
		...
		g_logger().warn("Criatura com id {} n\343o existe");
	}
	return nullptr;
}
...
std::shared_ptr<Creature> Game::getCreatureByName(const std::string &creatureName) {
	...
	// getCreatureByName
	const std::string &lowerCaseName = asLowerCaseString(toLatin1(creatureName));
	...
	if (it == mappedPlayerNames.end() || it->second.expired()) {
		...
		if (!IOLoginData::loadPlayerByName(tmpPlayer, s)) {
			if (!isNewName) {
				...
				g_logger().info("Novo nome {} est\341 dispon\355vel", s);
			}
			return nullptr;
		}
		tmpPlayer->setOnline(false);
...
bool Game::removeCreature(const std::shared_ptr<Creature> &creature, bool isLogout /* = true*/) {
	...
	if (!tile) {
		g_logger().error("[{}] bloco na posi\347\343o '{}' para criatura '{}' n\343o existe", __FUNCTION__, creature->getPosition().toString(), creature->getName());
	}
...
void Game::playerMoveCreature(const std::shared_ptr<Player> &player, const std::shared_ptr<Creature> &movingCreature, const Position &movingCreatureOrigPos, const std::shared_ptr<Tile> &toTile) {
	...
	g_dispatcher().addWalkEvent([=, this] {
		...
		// MCR: Permite empurrar criaturas mesmo que não sejam "pushable" se a flag de postura estiver ativa
		if (player->canPushCreatures()) {
			// O jogador pode empurrar qualquer criatura (as verificações de zona e bloco continuam abaixo)
		} else if (!isFamiliar && ((!movingCreature->isPushable() && !player->hasFlag(PlayerFlags_t::CanPushAllCreatures)) || (movingCreature->isInGhostMode() && !player->isAccessPlayer()))) {
...
ReturnValue Game::internalMoveCreature(const std::shared_ptr<Creature> &creature, Direction direction, uint32_t flags /*= 0*/) {
	...
	if (creature->getPlayer()) creature->getPlayer()->addSurfaceWaypoint(creature->getPosition());
...
// Verifica se um cilindro é um container remoto (aberto pelo nosso sistema)
bool isRemoteContainer(const std::shared_ptr<Player> &player, const std::shared_ptr<Cylinder> &cylinder) {
    if (!player || !cylinder) return false;
    auto container = cylinder->getContainer();
    if (!container) return false;
    if (player->isRemoteContainer(container)) return true;

    auto parent = container->getParent();
    while (parent) {
        auto parentContainer = parent->getContainer();
        if (parentContainer && player->isRemoteContainer(parentContainer)) return true;
        parent = parentContainer ? parentContainer->getParent() : nullptr;
    }
    return false;
}
...
void Game::playerMoveItem(const std::shared_ptr<Player> &player, const Position &fromPos, uint16_t itemId, uint8_t fromStackPos, const Position &toPos, uint8_t count, std::shared_ptr<Item> item, std::shared_ptr<Cylinder> toCylinder) {
    ...
    auto isPlayerCylinder = [&player](const std::shared_ptr<Cylinder> &cyl) -> bool {
        if (!cyl) return false;
        if (cyl.get() == player.get()) return true;
        auto current = cyl;
        while (current) {
            if (current.get() == player.get()) return true;
            current = current->getParent();
        }
        return false;
    };

	// ---- MCR: Identificar containers remotos ----
	bool fromRemote = isRemoteContainer(player, fromCylinder);
	bool toRemote = isRemoteContainer(player, toCylinder);
    ...
    // Se a origem não for remota nem o jogador, verifica o piso
    if (!fromRemote && !isPlayerCylinder(fromCylinder) && playerPos.z != mapFromPos.z) {
        player->sendCancelMessage(playerPos.z > mapFromPos.z ? RETURNVALUE_FIRSTGOUPSTAIRS : RETURNVALUE_FIRSTGODOWNSTAIRS);
        return;
    }

	// Caminhada automática (ignorada se remoto)
    // Se a origem não for remota nem o jogador, pode precisar de caminhar
    if (!fromRemote && !isPlayerCylinder(fromCylinder) && !Position::areInRange<1, 1>(playerPos, mapFromPos)) {
	...
	// hangable item specific code (inalterado)
    ...
    // Se o destino NÃO for remoto, NÃO for o jogador, E a origem NÃO for remota,
    // então verifica a distância e linha de visão.
    if (!toRemote && !isPlayerCylinder(toCylinder) && !fromRemote) {
	...
	if (item->isWrapable() || item->isStoreItem() || (item->hasOwner() && !item->isOwner(player))) {
		...
		if (fromHouseTile) {
			...
			if (!fromHouse || !toHouse || toHouse->getId() != fromHouse->getId()) {
				player->sendCancelMessage("Voc\352 n\343o pode mover este item para fora desta casa.");
				return;
			}
		}
	}
...
ReturnValue Game::internalMoveItem(std::shared_ptr<Cylinder> fromCylinder, std::shared_ptr<Cylinder> toCylinder, int32_t index, const std::shared_ptr<Item> &item, uint32_t count, std::shared_ptr<Item>* movedItem, uint32_t flags /*= 0*/, const std::shared_ptr<Creature> &actor /*=nullptr*/, const std::shared_ptr<Item> &tradeItem /* = nullptr*/, bool checkTile /* = true*/) {
	metrics::method_latency measure(__METRICS_METHOD_NAME__);
	if (fromCylinder == nullptr) {
		g_logger().error("[{}] fromCylinder \351 nullptr", __FUNCTION__);
		return RETURNVALUE_NOTPOSSIBLE;
	}
	if (toCylinder == nullptr) {
		g_logger().error("[{}] toCylinder \351 nullptr", __FUNCTION__);
		return RETURNVALUE_NOTPOSSIBLE;
	}
...
ReturnValue Game::internalAddItem(std::shared_ptr<Cylinder> toCylinder, const std::shared_ptr<Item> &item, int32_t index, uint32_t flags, bool test, uint32_t &remainderCount) {
	...
	if (item == nullptr) {
		g_logger().error("[{}] item \351 nullptr", __FUNCTION__);
		return RETURNVALUE_NOTPOSSIBLE;
	}
	...
	*/
    ...
    if (auto tile = toCylinder->getTile()) {
        g_globalMonsterMap().notifyTileChange(tile->getPosition());
    }
...
ReturnValue Game::internalRemoveItem(const std::shared_ptr<Item> &items, int32_t count /*= -1*/, bool test /*= false*/, uint32_t flags /*= 0*/, bool force /*= false*/) {
	...
	metrics::method_latency measure(__METRICS_METHOD_NAME__);
	if (item == nullptr) {
		g_logger().debug("{} - O item \351 nullptr", __FUNCTION__);
		return RETURNVALUE_NOTPOSSIBLE;
	}
	std::shared_ptr<Cylinder> cylinder = item->getParent();
	if (cylinder == nullptr) {
		g_logger().debug("{} - O cilindro est\341 nulo", __FUNCTION__);
		return RETURNVALUE_NOTPOSSIBLE;
	}
	...
	if (!force && ret != RETURNVALUE_NOERROR) {
		g_logger().debug("{} - Falha ao executar a consulta remover", __FUNCTION__);
		return ret;
	}
	if (!force && !item->canRemove()) {
		g_logger().debug("{} - Falha ao remover item", __FUNCTION__);
		return RETURNVALUE_NOTPOSSIBLE;
	}

	// Not remove item with decay loaded from map
	if (!force && item->canDecay() && cylinder->getTile() && item->isLoadedFromMap()) {
		g_logger().debug("N\343o \351 poss\355vel remover item com id {}, nome {}, na posi\347\343o {}", item->getID(), item->getName(), cylinder->getPosition().toString());
		item->stopDecaying();
    ...
    const auto &tile = cylinder->getTile(); // já existe uma variável 'tile'? Se sim, use-a.
...
std::tuple<ReturnValue, uint32_t, uint32_t> Game::addItemBatch(const std::shared_ptr<Cylinder> &toCylinder, const std::vector<std::shared_ptr<Item>> &items, uint32_t flags /* = 0 */, bool dropOnMap /* = true */, uint32_t autoContainerId /* = 0 */) {
	...
	auto setupDestination = [&]() -> std::shared_ptr<Cylinder> {
		...
		if (!autoContainer) {
			g_logger().error("[{}] Falha ao criar cont\352iner autom\341tico", __FUNCTION__);
			return toCylinder;
		}
		if (internalAddItem(toCylinder, autoContainer, CONST_SLOT_WHEREEVER, flags) != RETURNVALUE_NOERROR) {
			if (internalAddItem(toCylinder->getTile(), autoContainer, INDEX_WHEREEVER, FLAG_NOLIMIT) != RETURNVALUE_NOERROR) {
				g_logger().error("[{}] Falha ao adicionar cont\352iner autom\341tico", __FUNCTION__);
				return toCylinder;
			}
		}
		auto container = autoContainer->getContainer();
		if (!container) {
			g_logger().error("[{}] Falha ao obter cont\352iner autom\341tico", __FUNCTION__);
			return toCylinder;
		}
		containersCreated++;
		return container;
	...
	for (const auto &[itemId, count, subType] : itemCounts) {
		...
		for (uint32_t i = 0; i < count; ++i) {
			...
			if (itemType.isWrappable()) {
				...
				item->setAttribute(ItemAttribute_t::DESCRIPTION, "Desembrulhe este item em sua pr\363pria casa para criar um <" + itemType.name + ">.");
...
std::shared_ptr<Item> Game::findItemOfType(const std::shared_ptr<Cylinder> &cylinder, uint16_t itemId, bool depthSearch /*= true*/, int32_t subType /*= -1*/) const {
	metrics::method_latency measure(__METRICS_METHOD_NAME__);
	if (cylinder == nullptr) {
		g_logger().error("[{}] O cilindro \351 nullptr", __FUNCTION__);
		return nullptr;
	}
...
bool Game::removeMoney(const std::shared_ptr<Cylinder> &cylinder, uint64_t money, uint32_t flags /*= 0*/, bool useBalance /*= false*/) {
	if (cylinder == nullptr) {
		g_logger().error("[{}] cilindro \351 nullptr", __FUNCTION__);
		return false;
	}
	if (money == 0) {
		return true;
...
std::shared_ptr<Item> Game::transformItem(std::shared_ptr<Item> item, uint16_t newId, int32_t newCount /*= -1*/) {
		...
		if (newCount == 0 && (item->isStackable() || item->hasAttribute(ItemAttribute_t::CHARGES))) {
			if (item->isStackable()) {
				...
				if (newItemId < 0) {
					...
					if (newItem == nullptr) {
						g_logger().error("[{}] novo item com id {} \351 nullptr, (C\323DIGO DE ERRO: 01)", __FUNCTION__, newItemId);
						return nullptr;
					}
			...
			if (decaying > DECAYING_FALSE && item->getDuration() <= 1 && newType.decayTo) {
				g_logger().debug("Dura\347\343o do decaimento tipo antigo {}, transformEquipTo {}, transformDeEquipTo {}", curType.decayTo, curType.transformEquipTo, curType.transformDeEquipTo);
				g_logger().debug("Dura\347\343o do decaimento novo tipo decaimentoTo {}, transformEquipTo {}, transformDeEquipTo {}", newType.decayTo, newType.transformEquipTo, newType.transformDeEquipTo);
	...
	if (newItem == nullptr) {
		g_logger().error("[{}] novo item com id {} \351 nullptr (C\323DIGO DE ERRO: 02)", __FUNCTION__, newId);
		return nullptr;
	}
...
ReturnValue Game::internalTeleport(const std::shared_ptr<Thing> &thing, const Position &newPos, bool pushMove /* = true*/, uint32_t flags /*= 0*/) {
	metrics::method_latency measure(__METRICS_METHOD_NAME__);
	if (thing == nullptr) {
		g_logger().error("[{}] coisa \351 nullptr", __FUNCTION__);
		return RETURNVALUE_NOTPOSSIBLE;
	}
	...
	if (std::shared_ptr<Creature> creature = thing->getCreature()) {
		// Captura a transição de piso para o sistema de rastreamento do MCR
		if (thing->getPosition().z != newPos.z) {
			g_logger().info("[MCR-internalTeleport] Capturada mudança de piso: {} de {} para {}", 
				thing->getCreature() ? thing->getCreature()->getName() : "?",
				thing->getPosition().toString(), newPos.toString());
...
void Game::playerQuickLootCorpse(const std::shared_ptr<Player> &player, const std::shared_ptr<Container> &corpse, const Position &position) {
	...
	if (totalLootedGold != 0 || missedAnyGold || totalLootedItems != 0 || missedAnyItem) {
		...
		if (lootedAllGold) {
			if (totalLootedItems != 0 || missedAnyItem) {
				ss << "Voc\352 saqueou o completo " << totalLootedGold << " gold";

				if (lootedAllItems) {
					ss << " e todos os itens descartados";
				} else if (totalLootedItems != 0) {
					ss << ", mas voc\352 s\363 roubou alguns dos itens";
				} else if (missedAnyItem) {
					ss << " mas nenhum dos itens descartados";
				}
			} else {
				ss << "Voc\352 saqueou " << totalLootedGold << " gold";
			}
		} else if (lootedAllItems) {
			if (totalLootedItems == 1) {
				ss << "Voc\352 saqueou 1 item";
			} else if (totalLootedGold != 0 || missedAnyGold) {
				ss << "Voc\352 saqueou todos os itens descartados";
			} else {
				ss << "Voc\352 saqueou todos os itens";
			}

			if (totalLootedGold != 0) {
				ss << ", mas voc\352 s\363 saqueou " << totalLootedGold << " do ouro ca\355do";
			} else if (missedAnyGold) {
				ss << " mas nada do ouro ca\355do";
			}
		} else if (totalLootedGold != 0) {
			ss << "Voc\352 s\363 saqueou " << totalLootedGold << " do ouro ca\355do";
			if (totalLootedItems != 0) {
				ss << " e alguns dos itens descartados";
			} else if (missedAnyItem) {
				ss << " mas nenhum dos itens descartados";
			}
		} else if (totalLootedItems != 0) {
			ss << "Voc\352 saqueou alguns dos itens descartados";
			if (missedAnyGold) {
				ss << " mas nada do ouro ca\355do";
			}
		} else if (missedAnyGold) {
			ss << "Voc\352 n\343o saqueou nenhum ouro ca\355do";
			if (missedAnyItem) {
				ss << " e nenhum dos itens";
			}
		} else if (missedAnyItem) {
			ss << "Voc\352 n\343o saqueou nenhum dos itens descartados";
		}
	} else {
		ss << "Sem saque";
	}
	...
	if (shouldNotifyCapacity) {
		ss.str(std::string());
		ss << "Aten\347\343o! O saque que voc\352 est\341 tentando pegar \351 muito pesado para voc\352 carregar.";
	} else if (shouldNotifyNotEnoughRoom != OBJECTCATEGORY_NONE) {
		ss.str(std::string());
		ss << "Aten\347\343o! O cont\352iner atribu\355do \340 categoria " << getObjectCategoryName(shouldNotifyNotEnoughRoom) << " est\341 cheio.";
	} else {
		return;
	}
	...
	if (g_configManager().getBoolean(AUTOBANK)) {
		if (item->getID() == ITEM_GOLD_COIN || item->getID() == ITEM_PLATINUM_COIN || item->getID() == ITEM_CRYSTAL_COIN) {
			...
			if (parent) {
				...
				g_logger().debug("O item n\343o tem pai");
				return RETURNVALUE_NOTPOSSIBLE;
			}
			player->setBankBalance(player->getBankBalance() + money);
...
ReturnValue Game::collectRewardChestItems(const std::shared_ptr<Player> &player, uint32_t maxMoveItems /* = 0*/) {
	...
	if (rewardChest->empty()) {
		g_logger().debug("O ba\372 de recompensas est\341 vazio");
	...
	for (const auto &item : rewardItemsVector) {
		...
		if (limitMove) {
			lootedItemsMessage = fmt::format("Voc\352 s\363 pode coletar {} itens por vez. {} de {} objetos foram recolhidos.", maxMoveItems, movedRewardItems, rewardCount);
	...
	lootedItemsMessage = fmt::format("{} de {} objetos foram recolhidos.", movedRewardItems, rewardCount);
	player->sendTextMessage(MESSAGE_EVENT_ADVANCE, lootedItemsMessage);
...
uint64_t Game::getItemMarketPrice(const std::map<uint16_t, uint64_t> &itemMap, bool buyPrice) const {
	uint64_t total = 0;
	g_logger().debug("[{}] - Iniciando o c\341lculo com {} itens, buyPrice: {}", __FUNCTION__, itemMap.size(), buyPrice);
	...
	for (const auto &[itemId, count] : itemMap) {
		...
		if (itemId == ITEM_GOLD_COIN) {
			itemValue = count;
			total += itemValue;
			g_logger().debug("[{}] - Item {} (GOLD_COIN), contagem {}, unidade 1, total {}", __FUNCTION__, itemId, count, itemValue);
			continue;
		}
		...
		if (itemId == ITEM_PLATINUM_COIN) {
			itemValue = 100 * count;
			total += itemValue;
			g_logger().debug("[{}] - Item {} (PLATINUM_COIN), contagem {}, unidade 100, total {}", __FUNCTION__, itemId, count, itemValue);
			continue;
		}
		...
		if (itemId == ITEM_CRYSTAL_COIN) {
			...
			total += itemValue;
			g_logger().debug("[{}] - Item {} (CRYSTAL_COIN), contagem {}, unidade 10000, total {}", __FUNCTION__, itemId, count, itemValue);
			continue;
		}
		...
		if (marketIt != itemsPriceMap.end()) {
			...
			if (tierIt != tierMap.end()) {
				...
				total += itemValue;
				g_logger().debug("[{}] - Item {}, contagem {}, n\355vel {}, MARKET_PRICE {}, total {}", __FUNCTION__, itemId, count, tierIt->first, price, itemValue);
				continue;
			}
		}
		...
		total += itemValue;
		g_logger().debug("[{}] - Item {}, contagem {}, NPC_PRICE({}), unidade {}, total {}", __FUNCTION__, itemId, count, buyPrice ? "buy" : "sell", npcPrice, itemValue);
	}

	g_logger().debug("[{}] - Total final: {}", __FUNCTION__, total);
	return total;
}
...
void Game::playerEquipItem(uint32_t playerId, uint16_t itemId, bool hasTier /* = false*/, uint8_t tier /* = 0*/) {
    ...
    if (player->hasCondition(CONDITION_FEARED)) {
        player->sendTextMessage(MESSAGE_FAILURE, "Voc\352 est\341 amedrontado.");
        return;
    }
...
bool Game::playerBroadcastMessage(const std::shared_ptr<Player> &player, const std::string &text) const {
	...
	g_logger().info("{} transmitido: {}", player->getName(), text);
...
void Game::playerOpenPrivateChannel(uint32_t playerId, std::string &receiver) {
	...
	if (!IOLoginData::formatPlayerName(receiver)) {
		player->sendCancelMessage("N\343o existe um jogador com este nome.");
		return;
	}
...
void Game::playerUseItemEx(uint32_t playerId, const Position &fromPos, uint8_t fromStackPos, uint16_t fromItemId, const Position &toPos, uint8_t toStackPos, uint16_t toItemId) {
	...
	// Trigger do sistema de domínios para uso de itens (com alvo)
	g_creatureEvents().playerItemUse(player, item);
...
void Game::playerUseItem(uint32_t playerId, const Position &pos, uint8_t stackPos, uint8_t index, uint16_t itemId) {
	...
	// Trigger do sistema de domínios para uso de itens
	g_creatureEvents().playerItemUse(player, item);
...
void Game::playerSetShowOffSocket(uint32_t playerId, Outfit_t &outfit, const Position &pos, uint8_t stackPos, const uint16_t itemId, uint8_t podiumVisible, uint8_t direction) {
	...
	if (outfit.lookType != 0 || outfit.lookMount != 0) {
		...
		name << Item::items[item->getID()].name << " exibindo o ";
		bool outfited = false;
		if (outfit.lookType != 0) {
...
void Game::playerWrapableItem(uint32_t playerId, const Position &pos, uint8_t stackPos, const uint16_t itemId) {
	...
	if (!tile->hasFlag(TILESTATE_PROTECTIONZONE) || !houseTile) {
		player->sendCancelMessage("Voc\352 pode construir isso apenas dentro de uma casa.");
		return;
	}
	const auto &house = houseTile->getHouse();
	if (!house) {
	...
	if (house->getHouseAccessLevel(player) < HOUSE_OWNER) {
		player->sendCancelMessage("Voc\352 n\343o tem permiss\343o para construir isso aqui.");
		return;
	}
	...
	if (unwrappable || blockedUnwrap) {
		player->sendCancelMessage("Voc\352 s\363 pode embrulhar/desembrulhar n\343o ch\343o.");
		return;
	}
...
std::shared_ptr<Item> Game::wrapItem(const std::shared_ptr<Item> &item, const std::shared_ptr<House> &house) {
	...
	newItem->setAttribute(ItemAttribute_t::DESCRIPTION, "Voc\352 comprou este item na Loja.\nDesembrulhe-o em sua pr\363pria casa para criar um <" + itemName + ">.");
	if (hiddenCharges > 0) {
...
void Game::unwrapItem(const std::shared_ptr<Item> &item, uint16_t unWrapId, const std::shared_ptr<House> &house, const std::shared_ptr<Player> &player) {
	...
	if (player != nullptr && house != nullptr && newiType.isBed() && house->getMaxBeds() > -1 && house->getBedCount() >= house->getMaxBeds()) {
		player->sendCancelMessage("Voc\352 atingiu o n\372mero m\341ximo de camas nesta casa");
		return;
	}
...
void Game::playerStashWithdraw(uint32_t playerId, uint16_t itemId, uint32_t count, uint8_t) {
	...
	if (count > maxWithdrawLimit) {
		...
		limitMessage << "Voc\352 s\363 pode sacar at\351 " << maxWithdrawLimit << " items at a time from the stash.";
...
void Game::playerSeekInContainer(uint32_t playerId, uint8_t containerId, uint16_t index, uint8_t containerCategory) {
	...
	if (container->isStoreInbox()) {
		...
		g_logger().debug("Configurando novo cont\352iner com nome de categoria da caixa de entrada da loja {}", enumName);
	}
...
void Game::playerRequestTrade(uint32_t playerId, const Position &pos, uint8_t stackPos, uint32_t tradePlayerId, uint16_t itemId) {
	...
	if (!tradePartner || tradePartner == player) {
		player->sendTextMessage(MESSAGE_FAILURE, "Desculpe, n\343o \351 poss\355vel.");
		return;
	}

	if (!Position::areInRange<2, 2, 0>(tradePartner->getPosition(), player->getPosition())) {
		std::ostringstream ss;
		ss << tradePartner->getName() << " diz para voc\352 se aproximar.";
	...
	if (tradeItemContainer) {
		for (const auto &it : tradeItems) {
			...
			if (tradeItem == item) {
				player->sendTextMessage(MESSAGE_TRADE, "Este item j\341 est\341 sendo negociado.");
				return;
			}
	...
	if (tradeItemContainer && tradeItemContainer->getItemHoldingCount() + 1 > 100) {
		player->sendTextMessage(MESSAGE_TRADE, "Voc\352 n\343o pode negociar mais de 100 itens.");
		return;
	}

	if (tradeItem->isStoreItem()) {
		player->sendTextMessage(MESSAGE_TRADE, "Este item n\343o pode ser negociado.");
		return;
	}
...
bool Game::internalStartTrade(const std::shared_ptr<Player> &player, const std::shared_ptr<Player> &tradePartner, const std::shared_ptr<Item> &tradeItem) {
	...
	if (tradePartner->tradeState == TRADE_NONE) {
		std::ostringstream ss;
		ss << player->getName() << " quer negociar com voc\352.";
...
std::string Game::getTradeErrorDescription(ReturnValue ret, const std::shared_ptr<Item> &item) {
	if (item) {
		if (ret == RETURNVALUE_NOTENOUGHCAPACITY) {
			std::ostringstream ss;
			ss << "Voc\352 n\343o tem capacidade suficiente para carregar";
			...
			std::ostringstream ss;
			ss << "Voc\352 n\343o tem espa\347o suficiente para carregar";
	...
	return "A negocia\347\343o n\343o p\364de ser conclu\355da.";
}
...
void Game::internalCloseTrade(const std::shared_ptr<Player> &player) {
	...
	player->sendTextMessage(MESSAGE_FAILURE, "Negocia\347\343o cancelada.");
	player->sendTradeClose();
	...
	if (tradePartner) {
		...
		tradePartner->sendTextMessage(MESSAGE_FAILURE, "Negocia\347\343o cancelada.");
		tradePartner->sendTradeClose();
	}
}
...
void Game::playerLookInShop(uint32_t playerId, uint16_t itemId, uint8_t count) {
	...
	std::ostringstream ss;
	ss << "Voc\352 v\352 " << Item::getDescription(it, 1, nullptr, count);
...
void Game::playerQuickLoot(uint32_t playerId, const Position &pos, uint16_t itemId, uint8_t stackPos, const std::shared_ptr<Item> &defaultItem, bool lootAllCorpses, bool autoLoot) {
	...
	if (!autoLoot && pos.x != 0xffff) {
		...
		player->sendCancelMessage("Voc\352 deve ser premium.");
		return;
	}
	...
	if (pos.x == 0xffff && !browseField && !corpse->isRewardCorpse()) {
		...
		if (ret == RETURNVALUE_NOTENOUGHCAPACITY) {
			...
			ss << "Aten\347\343o! O recipiente para " << getObjectCategoryName(category) << " est\341 cheio.";
		} else {
			if (ret == RETURNVALUE_NOERROR) {
				player->sendLootStats(item, item->getItemCount());
				ss << "Voc\352 saqueou ";
			} else {
				ss << "Voc\352 n\343o poderia saquear ";
			}
	...
	if (lootAllCorpses) {
		...
		if (corpses > 0) {
			if (corpses > 1) {
				...
				string << "Voc\352 saqueou " << corpses << " corpses.";
...
void Game::playerSetFightModes(uint32_t playerId, FightMode_t fightMode, bool chaseMode, bool secureMode) {
    ...
    FightMode_t oldMode = player->getFightMode();  // GUARDA O MODO ANTIGO
    player->setFightMode(fightMode);
    player->setChaseMode(chaseMode);
    player->setSecureMode(secureMode);

    // Sinal MCR para scripts Lua
    g_creatureEvents().playerOnFightModeChange(player, oldMode, fightMode);
}
void Game::playerRequestAddVip(uint32_t playerId, const std::string &name) {
	...
	if (!vipPlayer) {
		...
		if (!IOLoginData::getGuidByNameEx(guid, specialVip, formattedName)) {
			player->sendTextMessage(MESSAGE_FAILURE, "N\343o existe um jogador com este nome.");
			return;
		}

		if (specialVip && !player->hasFlag(PlayerFlags_t::SpecialVIP)) {
			player->sendTextMessage(MESSAGE_FAILURE, "Voc\352 n\343o pode adicionar este jogador");
			return;
		}
...
void Game::playerApplyImbuement(uint32_t playerId, uint16_t imbuementid, uint8_t slot, bool protectionCharm) {
	...
	if (item->getTopParent() != player) {
		...
		player->sendImbuementResult("Ocorreu um erro, reabra a janela de imbuement. Se o problema persistir, entre em contato com seu administrador.");
		return;
	}
...
void Game::playerChangeOutfit(uint32_t playerId, Outfit_t outfit, bool setMount, uint8_t isMountRandomized /* = 0*/) {
	...
	if (outfit.lookShader != 0) {
		...
		playerAttachedEffects.sendShader(player, "Roupa - Padr\343o");
...
void Game::playerSay(uint32_t playerId, uint16_t channelId, SpeakClasses type, const std::string &receiver, const std::string &text) {
	...
	if (muteTime > 0) {
		std::ostringstream ss;
		ss << "Voc\352 ainda est\341 silenciado por " << muteTime << " seconds.";
...
bool Game::playerYell(const std::shared_ptr<Player> &player, const std::string &text) {
	if (player->getLevel() == 1) {
		player->sendTextMessage(MESSAGE_FAILURE, "Voc\352 n\343o pode gritar enquanto estiver n\343o n\355vel 1.");
		return false;
	}
...
bool Game::playerSpeakTo(const std::shared_ptr<Player> &player, SpeakClasses type, const std::string &receiver, const std::string &text) {
	...
	if (!toPlayer) {
		player->sendTextMessage(MESSAGE_FAILURE, "Um jogador com este nome n\343o est\341 online.");
		return false;
	}
...
void Game::reloadCreature(const std::shared_ptr<Creature> &creature) {
	if (!creature) {
		g_logger().error("[{}] A criatura \351 nullptr", __FUNCTION__);
		return;
	}
...
bool Game::combatBlockHit(CombatDamage &damage, const std::shared_ptr<Creature> &attacker, const std::shared_ptr<Creature> &target, bool checkDefense, bool checkArmor, bool field, bool condition /* = false */) {
	...
	if (targetPlayer) {
		...
		if ((chance > 0 && uniform_random(0, 10000) < chance) || damage.hazardDodge) {
			...
			targetPlayer->sendTextMessage(MESSAGE_ATTENTION, "Voc\352 se esquivou de um ataque.");
			return true;
		}
	}
		...
		if (!damage.extension && attacker) {
			...
			if (primaryReflectPercent > 0 || primaryReflectFlat > 0) {
				...
				if (target->getMonster() || damage.primary.type != COMBAT_PHYSICALDAMAGE || primaryReflectPercent > 0 || std::max(distanceX, distanceY) < 2) {
					...
					damageReflected.exString += " (reflexo de dano)";
	...
	if (damageAbsorbMessage) {
		...
		damage.exString += "resili\352ncia elemental ativa";
	}
	...
	if (damageIncreaseMessage) {
		...
		damage.exString += "amplifica\347\343o elementar ativa";
	}
...
void Game::notifySpectators(const CreatureVector &spectators, const Position &targetPos, const std::shared_ptr<Player> &attackerPlayer, const std::shared_ptr<Monster> &targetMonster) {
	if (!spectators.empty()) {
		for (const auto &spectator : spectators) {
			...
			std::stringstream ss;
			ss << ucfirst(targetMonster->getNameDescription()) << " se esquivou";
			if (tmpPlayer == attackerPlayer) {
				...
				ss << " um ataque de " << attackerPlayer->getName() << ". (Perigo)";
...
void Game::applyWheelOfDestinyHealing(CombatDamage &damage, const std::shared_ptr<Player> &attackerPlayer, std::shared_ptr<Creature> target) {
	...
	if (attackerPlayer) {
		...
		if (attackerPlayer->wheel().getInstant("B\352n\347\343o do Bosque")) {
...
void Game::applyWheelOfDestinyEffectsToDamage(CombatDamage &damage, const std::shared_ptr<Player> &attackerPlayer, const std::shared_ptr<Creature> &target) const {
	...
	if (attackerPlayer) {
		...
		if (damage.instantSpellName == "Explos\343o de gelo" || damage.instantSpellName == "Explos\343o da Terra") {
		...
		if (damage.instantSpellName == "Lan\347amento do Carrasco") {
		...
		if (damage.instantSpellName == "Granada Divina") {
...
int32_t Game::applyHealthChange(const CombatDamage &damage, const std::shared_ptr<Creature> &target) const {
	...
	if (std::shared_ptr<Player> targetPlayer = target->getPlayer()) {
		if (targetPlayer->wheel().getInstant("Presente da Vida") && targetPlayer->wheel().getGiftOfCooldown() == 0 && (damage.primary.value + damage.secondary.value) >= targetHealth) {
...
bool Game::combatChangeHealth(const std::shared_ptr<Creature> &attacker, const std::shared_ptr<Creature> &target, CombatDamage &damage, bool isEvent /*= false*/) {
	...
	if (damage.primary.value > 0) {
		...
		if (realHealthChange > 0 && !target->isInGhostMode()) {
			...
			for (const auto &spectator : Spectators().find<Player>(targetPos)) {
				...
				if (tmpPlayer == attackerPlayer && attackerPlayer != targetPlayer) {
					ss.str({});
					ss << "Voc\352 cura " << target->getNameDescription() << " for " << damageString;
					message.type = MESSAGE_HEALED;
					message.text = ss.str();
				} else if (tmpPlayer == targetPlayer) {
					ss.str({});
					if (!attacker) {
						ss << "Voc\352 foi curado";
					} else if (targetPlayer == attackerPlayer) {
						ss << "Voc\352 se cura";
					} else {
						ss << "Voc\352 foi curado por " << attacker->getNameDescription();
					}
					ss << " for " << damageString;
					message.type = MESSAGE_HEALED;
					message.text = ss.str();
		...
		if (target->hasCondition(CONDITION_MANASHIELD) && damage.primary.type != COMBAT_UNDEFINEDDAMAGE) {
			...
			if (manaDamage != 0) {
				...
				for (const auto &spectator : spectators) {
					...
					if (tmpPlayer == attackerPlayer && attackerPlayer != targetPlayer) {
						ss.str({});
						ss << ucfirst(target->getNameDescription()) << " loses " << damageString + " mana devido ao seu " << attackMsg << ".";
						...
						ss.str({});
						ss << "Voc\352 perde " << damageString << " mana";
						if (!attacker) {
							ss << '.';
						} else if (targetPlayer == attackerPlayer) {
							ss << " devido ao seu pr\363prio " << attackMsg << ".";
						} else {
							ss << " devido a um " << attackMsg << " by " << attacker->getNameDescription() << '.';
						}
						...
						if (spectatorMessage.empty()) {
							...
							if (attacker) {
								ss << " devido a ";
								if (attacker == target) {
									ss << (targetPlayer ? targetPlayer->getPossessivePronoun() : "its") << " pr\363prio ataque";
								} else {
		...
		// MCR: aplica modificador de dano recebido (postura de Guarda, etc.)
		if (targetPlayer) {
			realDamage = static_cast<int32_t>(realDamage * targetPlayer->getDamageTakenModifier());
			damage.primary.value = static_cast<int32_t>(damage.primary.value * targetPlayer->getDamageTakenModifier());
			damage.secondary.value = static_cast<int32_t>(damage.secondary.value * targetPlayer->getDamageTakenModifier());
		}
		...
		// MCR: aumento de engajamento do monstro atacante ao causar dano a jogador
		if (attackerMonster && targetPlayer && realDamage > 0) {
			attackerMonster->setEngagement(std::min(100, attackerMonster->getEngagement() + 2));
		}

		// Evento MCR: progressão por dano
		if (attackerPlayer && realDamage > 0) {
			g_creatureEvents().playerOnDealtDamage(attackerPlayer, target, realDamage, damage.primary.type, damage.secondary.type);
		}
		...
		if (attacker) {
			...
			if (attacker == target) {
				if (targetPlayer) {
					...
					ss << "pr\363prio " << attackMsg << "attack";
				}
			} else {
				ss << article << " " << attackMsg << "ataque por " << attacker->getNameDescription();
			}
		}
		ss << '.';
		if (damage.extension) {
...
void Game::buildMessageAsTarget(
	...
	ss << "Voc\352 perde " << damageString;
	if (!attacker) {
		ss << '.';
	} else if (targetPlayer == attackerPlayer) {
		ss << " devido ao seu pr\363prio " << attackMsg << "attack.";
	} else {
		ss << " devido a " << article << " " << attackMsg << "ataque por " << attacker->getNameDescription() << '.';
	}
	if (damage.extension) {
		ss << " " << damage.exString;
	}
	if (handleSoulPit && damage.critical) {
		ss << " (Cr\355tico da Alma)";
	}
	message.type = MESSAGE_DAMAGE_RECEIVED;
	message.text = ss.str();
}
...
void Game::buildMessageAsAttacker(
	...
	ss.str({});
	ss << ucfirst(target->getNameDescription()) << " loses " << damageString << " devido ao seu " << (damage.critical ? "critical " : " ") << "attack.";
	...
	if (damage.critical && target->getMonster() && attackerPlayer) {
		...
		static const std::pair<charmRune_t, std::string_view> charms[] = {
			{ CHARM_LOW, " (charme de golpe baixo)" },
			{ CHARM_SAVAGE, " (feiti\347o de golpe selvagem)" }
		};
	...
	if (damage.fatal) {
		ss << (amplified ? " (Ataque Amplificado)" : " (Onslaught)");
	}
	message.type = MESSAGE_DAMAGE_DEALT;
	message.text = ss.str();
}
...
void Game::applyManaLeech(
    ...
    // MCR – modificador de mana leech por postura/domínio
    if (attackerPlayer->getManaLeechModifier() != 0.0f) {
        manaSkill += static_cast<uint16_t>(attackerPlayer->getManaLeechModifier() * 100);
    }
...
void Game::applyLifeLeech(
    ...
    // MCR – modificador de life leech por postura/domínio
    if (attackerPlayer->getLifeLeechModifier() != 0.0f) {
        lifeSkill += static_cast<uint16_t>(attackerPlayer->getLifeLeechModifier() * 100);
    }
	...
	if (manaChange > 0) {
		...
		if (realManaChange > 0 && !target->isInGhostMode()) {
			...
			if (!attacker) {
				...
				spectatorMessage += " foi restaurado para " + damageString;
			} else {
			...
			for (const auto &spectator : spectators) {
				...
				if (tmpPlayer == attackerPlayer && attackerPlayer != targetPlayer) {
					message.type = MESSAGE_HEALED;
					message.text = "Voc\352 restaurou " + target->getNameDescription() + " for " + damageString;
				} else if (tmpPlayer == targetPlayer) {
					message.type = MESSAGE_HEALED;
					if (!attacker) {
						message.text = "Voc\352 foi restaurado para " + damageString;
					} else if (targetPlayer == attackerPlayer) {
						message.text = "Voc\352 se restaura para " + damageString;
					} else {
						message.text = "Voc\352 foi restaurado por " + attacker->getNameDescription() + " for " + damageString;
					}
				} else {
					message.type = MESSAGE_HEALED_OTHERS;
					message.text = spectatorMessage;
		...
		for (const auto &spectator : spectators) {
			...
			if (tmpPlayer == attackerPlayer && attackerPlayer != targetPlayer) {
				ss.str({});
				ss << ucfirst(target->getNameDescription()) << " loses " << damageString << " mana devido ao seu ataque.";
				message.type = MESSAGE_DAMAGE_DEALT;
				message.text = ss.str();
			} else if (tmpPlayer == targetPlayer) {
				ss.str({});
				...
				if (!attacker) {
					...
					ss << " devido ao seu pr\363prio ataque.";
				} else {
...
void Game::shutdown() {
	g_webhook().sendMessage(":red_circle: O servidor est\341 desligando...");

	g_logger().info("Desligando...");
...
void Game::broadcastMessage(const std::string &text, MessageClasses type) const {
	if (!text.empty()) {
		g_logger().info("Mensagem transmitida: {}", text);
		for (const auto &it : players) {
...
void Game::playerInviteToParty(uint32_t playerId, uint32_t invitedId) {
	...
	if (invitedPlayer->getParty()) {
		std::ostringstream ss;
		ss << invitedPlayer->getName() << " j\341 est\341 em uma festa.";
...
void Game::playerJoinParty(uint32_t playerId, uint32_t leaderId) {
	...
	if (player->getParty()) {
		player->sendTextMessage(MESSAGE_PARTY_MANAGEMENT, "Voc\352 j\341 est\341 em uma festa.");
		return;
	}
...
void Game::playerLeaveParty(uint32_t playerId) {
	...
	if (!party || (player->hasCondition(CONDITION_INFIGHT) && player->getZoneType() != ZONE_PROTECTION)) {
		player->sendTextMessage(TextMessage(MESSAGE_FAILURE, "Voc\352 n\343o pode sair do grupo, entre em contato com o administrador."));
		return;
	}
...
std::string Game::generateHighscoreQuery(
	...
	if (categoryName.empty()) {
		g_logger().error("O nome da categoria n\343o pode ficar vazio.");
		return "";
	}
...
namespace {
	bool removeOfferItems(const std::shared_ptr<Player> &player, const std::shared_ptr<DepotLocker> &depotLocker, const ItemType &itemType, uint16_t amount, uint8_t tier, std::ostringstream &offerStatus) {
		...
		if (removeAmount > 0) {
			if (totalCount == 0 || itemVector.empty()) {
				offerStatus << "Player " << player->getName() << " n\343o tenho item para criar oferta";
				return false;
			}
			...
			for (const auto &item : itemVector) {
				...
				if (ret != RETURNVALUE_NOERROR) {
					offerStatus << "Falha ao remover: " << amount << " itens de id: " << itemType.id << " from player " << player->getName() << " error: " << getReturnMessage(ret);
					return false;
				}
			...
			if (removedCount < removeAmount) {
				g_logger().error("O jogador {} tentou vender um item {} sem este item", player->getName(), itemType.id);
				offerStatus << "O item que voc\352 tentou comercializar n\343o est\341 correto. Verifique o item novamente.";
				return false;
			}
		}
		return true;
	...
	void processItemInsertion(const std::shared_ptr<Player> &recipient, uint16_t itemId, uint16_t &amount, uint8_t tier, uint64_t &totalPrice, uint32_t pricePerItem) {
		...
		if (returnValue != RETURNVALUE_NOERROR) {
			if (actuallyAdded == 0) {
				recipient->sendTextMessage(MESSAGE_MARKET, fmt::format("N\343o h\341 espa\347o suficiente na sua caixa de entrada."));
			} else {
				recipient->sendTextMessage(MESSAGE_MARKET, fmt::format("N\343o h\341 espa\347o suficiente na sua caixa de entrada para todos os itens, apenas {} itens foram processados.", actuallyAdded));
				g_logger().warn("{} - Falha ao adicionar o item {} valor total {}, atualmente adicionado: {} \340 caixa de entrada do jogador {}, c\363digo de erro: {}", __FUNCTION__, itemId, amount, actuallyAdded, recipient->getName(), getReturnMessage(returnValue));
			}
		}
...
bool checkCanInitCreateMarketOffer(const std::shared_ptr<Player> &player, uint8_t type, const ItemType &it, uint16_t amount, uint64_t price, std::ostringstream &offerStatus) {
	if (!player) {
		offerStatus << "Falha ao carregar o jogador";
		return false;
	}

	if (!player->getAccount()) {
		offerStatus << "Falha ao carregar a conta do jogador";
		return false;
	}

	if (!player->isInMarket()) {
		offerStatus << "Falha ao carregar o mercado para o jogador " << player->getName();
		return false;
	}

	if (price == 0) {
		offerStatus << "Falha ao processar o pre\347o do jogador " << player->getName();
		return false;
	}

	if (price > 999999999999) {
		offerStatus << "Player " << player->getName() << " est\341 tentando vender um item com valor superior ao permitido";
		return false;
	}

	if (type != MARKETACTION_BUY && type != MARKETACTION_SELL) {
		offerStatus << "Falha ao processar o tipo " << type << "para jogador " << player->getName();
		return false;
	}
	...
	if (it.id == 0 || it.wareId == 0) {
		offerStatus << "Falha ao carregar a oferta ou o ID do item";
		return false;
	}

	if (amount == 0 || (!it.stackable && amount > 2000) || (it.stackable && amount > 64000)) {
		offerStatus << "Falha ao carregar o valor " << amount << " para jogador " << player->getName();
		return false;
	}

	g_logger().debug("{} - Valor da oferta: {}", __FUNCTION__, amount);

	if (g_configManager().getBoolean(MARKET_PREMIUM) && !player->isPremium()) {
		player->sendTextMessage(MESSAGE_MARKET, "Somente contas premium podem criar ofertas para esse objeto.");
		return false;
	}
	...
	if (maxOfferCount != 0 && IOMarket::getPlayerOfferCount(player->getGUID()) >= maxOfferCount) {
		offerStatus << "Player " << player->getName() << "contagem m\341xima de ofertas excedida " << maxOfferCount;
		return false;
	}
...
void Game::playerCreateMarketOffer(uint32_t playerId, uint8_t type, uint16_t itemId, uint16_t amount, uint64_t price, uint8_t tier, bool anonymous) {
	...
	if (!checkCanInitCreateMarketOffer(player, type, it, amount, price, offerStatus)) {
		g_logger().error("{} - O jogador {} teve um erro na oferta de inicializa\347\343o do mercado, c\363digo de erro: {}", __FUNCTION__, player->getName(), offerStatus.str());
		return;
	}
	...
	if (type == MARKETACTION_SELL) {
		if (fee > (player->getMoney() + player->getBankBalance())) {
			offerStatus << "A taxa \351 maior que o dinheiro do jogador";
			return;
		}

		const std::shared_ptr<DepotLocker> &depotLocker = player->getDepotLocker(player->getLastDepotId());
		if (depotLocker == nullptr) {
			offerStatus << "O arm\341rio do dep\363sito \351 nullptr para o jogador " << player->getName();
			return;
		}
		...
		if (it.id == ITEM_STORE_COIN) {
			...
			if (amount > transferableCoins) {
				offerStatus << "O valor \351 maior que moedas para o jogador " << player->getName();
				return;
			}
		...
		g_metrics().addCounter("equil\355brio_decremento", fee, { { "player", player->getName() }, { "context", "market_fee" } });
	} else {
		uint64_t totalPrice = price * amount;
		totalPrice += fee;
		if (totalPrice > (player->getMoney() + player->getBankBalance())) {
			offerStatus << "A taxa \351 maior que o dinheiro do jogador (oferta de compra)";
			return;
		}

		g_game().removeMoney(player, totalPrice, 0, true);
		g_metrics().addCounter("equil\355brio_decremento", totalPrice, { { "player", player->getName() }, { "context", "market_offer" } });
	}
	...
	if (!offerStatus.str().empty()) {
		if (offerStatus.str() == "O item que voc\352 tentou comercializar n\343o est\341 correto. Verifique o item novamente.") {
			player->sendTextMessage(MESSAGE_MARKET, offerStatus.str());
		} else {
			player->sendTextMessage(MESSAGE_MARKET, "Ocorreu um erro ao processar sua oferta. Entre em contato com o administrador.");
		}
		g_logger().error("{} - O jogador {} teve um erro ao criar uma oferta n\343o mercado, c\363digo de erro: {}", __FUNCTION__, player->getName(), offerStatus.str());
		return;
	}
...
void Game::playerCancelMarketOffer(uint32_t playerId, uint32_t timestamp, uint16_t counter) {
	...
	if (offer.type == MARKETACTION_BUY) {
		...
		g_metrics().addCounter("equil\355brio_decremento", offer.price * offer.amount, { { "player", player->getName() }, { "context", "mercado_compra" } });
...
void Game::playerAcceptMarketOffer(uint32_t playerId, uint32_t timestamp, uint16_t counter, uint16_t amount) {
	...
	if (!player->isInMarket()) {
		offerStatus << "Falha ao carregar o mercado";
		return;
	}
	...
	MarketOfferEx offer = IOMarket::getOfferByCounter(timestamp, counter);
	if (offer.id == 0) {
		offerStatus << "Falha ao carregar o ID da oferta";
		return;
	}

	const ItemType &it = Item::items[offer.itemId];
	if (it.id == 0) {
		offerStatus << "Falha ao carregar o ID do item";
		return;
	}
	...
	if (amount == 0 || (!it.stackable && amount > 2000) || (it.stackable && amount > 64000) || amount > offer.amount) {
		offerStatus << "Valor da oferta inv\341lido " << amount << " para jogador " << player->getName();
		return;
	}
	...
	if (offer.type == MARKETACTION_BUY) {
		const std::shared_ptr<DepotLocker> &depotLocker = player->getDepotLocker(player->getLastDepotId());
		if (depotLocker == nullptr) {
			offerStatus << "O arm\341rio do dep\363sito \351 nullptr";
			return;
		}

		const std::shared_ptr<Player> &buyerPlayer = getPlayerByGUID(offer.playerId, true);
		if (!buyerPlayer) {
			offerStatus << "Falha ao carregar o jogador comprador " << player->getName();
			return;
		}

		const auto &buyerPlayerAccount = buyerPlayer->getAccount();
		if (!buyerPlayerAccount) {
			player->sendTextMessage(MESSAGE_MARKET, "N\343o \351 poss\355vel aceitar a oferta.");
			return;
		}

		const auto &playerAccount = player->getAccount();
		if (player == buyerPlayer || playerAccount == buyerPlayerAccount) {
			player->sendTextMessage(MESSAGE_MARKET, "Voc\352 n\343o pode aceitar sua pr\363pria oferta.");
			return;
		}
		...
		if (it.id == ITEM_STORE_COIN) {
			...
			if (error != AccountErrors_t::Ok) {
				offerStatus << "Falha ao carregar moedas transfer\355veis para o jogador " << player->getName();
				return;
			}

			if (amount > transferableCoins) {
				offerStatus << "O valor \351 maior que moedas";
				return;
			}
		...
		if (it.id == ITEM_STORE_COIN) {
			buyerPlayer->getAccount()->addCoins(CoinType::Transferable, amount, "Comprado n\343o mercado");
		} else {
		...
		if (!sellerPlayer) {
			offerStatus << "Falha ao carregar o jogador do vendedor";
			return;
		}
		...
		g_metrics().addCounter("equil\355brio_decremento", totalPrice, { { "player", player->getName() }, { "context", "mercado_compra" } });

		if (it.id == ITEM_STORE_COIN) {
			player->getAccount()->addCoins(CoinType::Transferable, amount, "Comprado n\343o mercado");
		} else {
			uint16_t processedAmount = amount;
			uint64_t effectivePrice = offer.price * processedAmount;
		...
		if (it.id == ITEM_STORE_COIN) {
			sellerPlayer->getAccount()->registerCoinTransaction(CoinTransactionType::Remove, CoinType::Transferable, amount, "Vendido n\343o mercado");
		}
	...
	if (!offerStatus.str().empty()) {
		player->sendTextMessage(MESSAGE_MARKET, "Ocorreu um erro ao processar sua oferta. Entre em contato com o administrador.");
		g_logger().error("{} - O jogador {} teve um erro ao aceitar uma oferta n\343o mercado, c\363digo de erro: {}", __FUNCTION__, player->getName(), offerStatus.str());
		return;
	}
...
void Game::playerAnswerModalWindow(uint32_t playerId, uint32_t modalWindowId, uint8_t button, uint8_t choice) {
	...
	if (modalWindowId == std::numeric_limits<uint32_t>::max()) {
		if (button == 1) {
			...
			player->sendTextMessage(MESSAGE_EVENT_ADVANCE, "Treinamento off-line abortado.");
		}
...
void Game::playerBosstiarySlot(uint32_t playerId, uint8_t slotId, uint32_t selectedBossId) {
	...
	if (uint32_t boostedBossId = g_ioBosstiary().getBoostedBossId();
		...
		g_metrics().addCounter("equil\355brio_decremento", removePrice, { { "player", player->getName() }, { "context", "bosstiary_remove" } });
...
void Game::playerSetMonsterPodium(uint32_t playerId, uint32_t monsterRaceId, const Position &pos, uint8_t stackPos, const uint16_t itemId, uint8_t direction, const std::pair<uint8_t, uint8_t> &podiumAndMonsterVisible) {
	...
	if (!mType) {
		player->sendCancelMessage(RETURNVALUE_NOTPOSSIBLE);
		g_logger().debug("[{}] jogador {} est\341 tentando adicionar monstro inv\341lido ao p\363dio {}", __FUNCTION__, player->getName(), item->getName());
		return;
	}
...
void Game::playerOpenWheel(uint32_t playerId, uint32_t ownerId) {
	...
	if (playerId != ownerId) {
		g_logger().error("[{}] o jogador {} est\341 tentando abrir a roda de outro jogador", __FUNCTION__, player->getName());
		return;
	}
...
void Game::playerWheelGemAction(uint32_t playerId, NetworkMessage &msg) {
	...
	switch (static_cast<WheelGemAction_t>(action)) {
		...
		case WheelGemAction_t::ImproveGrade:
			...
			break;
		default:
			g_logger().error("[{}] o jogador {} est\341 tentando realizar uma a\347\343o inv\341lida {} na roda", __FUNCTION__, player->getName(), action);
			break;
	}
	player->updateUIExhausted();
}
...
void Game::addPlayer(const std::shared_ptr<Player> &player) {
    const std::string &lowercase_name = asLowerCaseString(toLatin1(player->getName()));
...
void Game::refreshPlayerNameMapping(const std::shared_ptr<Player> &player) {
    // Remove a entrada antiga (caso exista) e reinsere com o nome em Latin-1
    std::string oldKey = asLowerCaseString(player->getName());
    auto it = mappedPlayerNames.find(oldKey);
    if (it != mappedPlayerNames.end()) {
        mappedPlayerNames.erase(it);
        wildcardTree->remove(oldKey);
    }
    std::string newKey = asLowerCaseString(toLatin1(player->getName()));
    mappedPlayerNames[newKey] = player;
    wildcardTree->insert(newKey);
}
...
bool Game::addUniqueItem(uint16_t uniqueId, std::shared_ptr<Item> item) {
	...
	if (!result.second) {
		g_logger().warn("ID exclusivo duplicado: {}", uniqueId);
	}
...
uint32_t Game::makeFiendishMonster(uint32_t forgeableMonsterId /* = 0*/, bool createForgeableMonsters /* = false*/) {
	...
	if (intervalTime == 0) {
		g_logger().warn("O tipo de intervalo diab\363lico est\341 errado, definindo o tempo padr\343o como 1h");
		finalTime = 3600 * 1000;
	} else {
...
void Game::createFiendishMonsters() {
	...
	while (fiendishMonsters.size() < fiendishLimit) {
		if (fiendishMonsters.size() >= fiendishLimit) {
			g_logger().warn("[{}] - Retornando na cria\347\343o do Fiendish, tamanho: {}, m\341ximo \351: {}.", __FUNCTION__, fiendishMonsters.size(), fiendishLimit);
			break;
		}
...
void Game::createInfluencedMonsters() {
	...
	while (created < influencedLimit) {
		if (influencedMonsters.size() >= influencedLimit) {
			g_logger().warn("[{}] - Voltando na cria\347\343o de Influenciados, tamanho: {}, m\341ximo \351: {}.", __FUNCTION__, influencedMonsters.size(), influencedLimit);
			break;
		}
...
void Game::playerCheckActivity(const std::string &playerName, int interval) {
	...
	if (player->getIP() == 0) {
		...
		g_logger().info("Jogador com nome '{}' desconectou-se devido a sa\355da na tela de morte", player->getName());
		player->disconnect();
		return;
	}
	...
	if (!player->isAccessPlayer()) {
		...
		if (player->m_deathTime > (kickAfterMinutes * 60000) + 60000) {
			g_game().removeDeadPlayer(playerName);
			g_logger().info("Jogador com nome '{}' desconectou-se devido \340 inatividade ap\363s a morte", player->getName());
			player->disconnect();
			return;
		}
	}
...
void Game::transferHouseItemsToDepot() {
	...
	if (!transferHouseItemsToPlayer.empty()) {
		g_logger().info("Inicializando itens de transfer\352ncia dom\351stica");
	}
	...
	for (const auto &[houseId, playerGuid] : transferHouseItemsToPlayer) {
		...
		if (house) {
			...
			g_logger().info("Transferindo itens para a caixa de entrada do jogador '{}'", offlinePlayer->getName());
	...
	if (transferSuccess > 0) {
		g_logger().info("Concluída a transferência de itens da casa de '{}' jogadores", transferSuccess);
...
void Game::logCyclopediaStats() {
	g_logger().info("Carregados {} emblemas do Sistema de Emblemas", m_badges.size());
	g_logger().info("Carregados {} títulos do Sistema de Títulos", m_titles.size());
}
...
void Game::playerCyclopediaHouseMoveOut(uint32_t playerId, uint32_t houseId, uint32_t timestamp) {
	...
	std::shared_ptr<Player> player = getPlayerByID(playerId);
	if (!player) {
		g_logger().warn("[{}] Jogador {} n\343o encontrado ao processar solicita\347\343o de leil\343o da casa.", __FUNCTION__, playerId);
		return;
	}
