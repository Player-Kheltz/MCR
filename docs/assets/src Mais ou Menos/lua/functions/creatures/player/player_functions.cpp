...
void PlayerFunctions::init(lua_State* L) {
	...
	// MCR – Domínios e Afinidade
	Lua::registerMethod(L, "Player", "getDominioAfinidade", PlayerFunctions::luaPlayerGetDominioAfinidade);
	Lua::registerMethod(L, "Player", "addDominioAfinidade", PlayerFunctions::luaPlayerAddDominioAfinidade);
	Lua::registerMethod(L, "Player", "setDominioDespertado", PlayerFunctions::luaPlayerSetDominioDespertado);
	Lua::registerMethod(L, "Player", "hasHabilidade", PlayerFunctions::luaPlayerHasHabilidade);
	Lua::registerMethod(L, "Player", "learnHabilidade", PlayerFunctions::luaPlayerLearnHabilidade);
	
	// MCR – Velocidade de ataque dinamica
	Lua::registerMethod(L, "Player", "getAttackSpeedModifier", PlayerFunctions::luaPlayerGetAttackSpeedModifier);
	Lua::registerMethod(L, "Player", "setAttackSpeedModifier", PlayerFunctions::luaPlayerSetAttackSpeedModifier);
	
	// MCR – Regeneração de vida e mana dinamica
	Lua::registerMethod(L, "Player", "getManaRegenModifier", PlayerFunctions::luaPlayerGetManaRegenModifier);
	Lua::registerMethod(L, "Player", "setManaRegenModifier", PlayerFunctions::luaPlayerSetManaRegenModifier);
	Lua::registerMethod(L, "Player", "getHealthRegenModifier", PlayerFunctions::luaPlayerGetHealthRegenModifier);
	Lua::registerMethod(L, "Player", "setHealthRegenModifier", PlayerFunctions::luaPlayerSetHealthRegenModifier);
	Lua::registerMethod(L, "Player", "getHealthRegenTicksModifier", PlayerFunctions::luaPlayerGetHealthRegenTicksModifier);
	Lua::registerMethod(L, "Player", "setHealthRegenTicksModifier", PlayerFunctions::luaPlayerSetHealthRegenTicksModifier);
	Lua::registerMethod(L, "Player", "getManaRegenTicksModifier", PlayerFunctions::luaPlayerGetManaRegenTicksModifier);
	Lua::registerMethod(L, "Player", "setManaRegenTicksModifier", PlayerFunctions::luaPlayerSetManaRegenTicksModifier);

	// MCR – Range Dinamica
	Lua::registerMethod(L, "Player", "getRangeModifier", PlayerFunctions::luaPlayerGetRangeModifier);
	Lua::registerMethod(L, "Player", "setRangeModifier", PlayerFunctions::luaPlayerSetRangeModifier);

	// MCR – Stealth Dinamico (furtividade)
	Lua::registerMethod(L, "Player", "setStealth", PlayerFunctions::luaPlayerSetStealth);
	Lua::registerMethod(L, "Player", "isStealth", PlayerFunctions::luaPlayerIsStealth);

	// MCR – Posturas de Combate
	Lua::registerMethod(L, "Player", "setCanPushCreatures", PlayerFunctions::luaPlayerSetCanPushCreatures);
	Lua::registerMethod(L, "Player", "canPushCreatures", PlayerFunctions::luaPlayerCanPushCreatures);

	// MCR - Vida e Mana Leech
	Lua::registerMethod(L, "Player", "setLifeLeechModifier", PlayerFunctions::luaPlayerSetLifeLeechModifier);
	Lua::registerMethod(L, "Player", "getLifeLeechModifier", PlayerFunctions::luaPlayerGetLifeLeechModifier);
	Lua::registerMethod(L, "Player", "setManaLeechModifier", PlayerFunctions::luaPlayerSetManaLeechModifier);
	Lua::registerMethod(L, "Player", "getManaLeechModifier", PlayerFunctions::luaPlayerGetManaLeechModifier);

	// MCR – Dano Recebido Dinamico
	Lua::registerMethod(L, "Player", "getDamageTakenModifier", PlayerFunctions::luaPlayerGetDamageTakenModifier);
	Lua::registerMethod(L, "Player", "setDamageTakenModifier", PlayerFunctions::luaPlayerSetDamageTakenModifier);

	// MCR - Sistema de Dominios
	Lua::registerMethod(L, "Player", "registerDominioAction", PlayerFunctions::luaPlayerRegisterDominioAction);
	Lua::registerMethod(L, "Player", "getDominioState", PlayerFunctions::luaPlayerGetDominioState);
	Lua::registerMethod(L, "Player", "setDominioState", PlayerFunctions::luaPlayerSetDominioState);
	Lua::registerMethod(L, "Player", "getAllActiveStates", PlayerFunctions::luaPlayerGetAllActiveStates);
	Lua::registerMethod(L, "Player", "getActionHistory", PlayerFunctions::luaPlayerGetActionHistory);
	Lua::registerMethod(L, "Player", "clearActionHistory", PlayerFunctions::luaPlayerClearActionHistory);
	Lua::registerMethod(L, "Player", "getStorages", PlayerFunctions::luaPlayerGetStorages);
	Lua::registerMethod(L, "Player", "setStorages", PlayerFunctions::luaPlayerSetStorages);
	Lua::registerMethod(L, "Player", "addDominioAfinidadeBatch", PlayerFunctions::luaPlayerAddDominioAfinidadeBatch);
	Lua::registerMethod(L, "Player", "getDominioAfinidades", PlayerFunctions::luaPlayerGetDominioAfinidades);
	Lua::registerMethod(L, "Player", "getCombatModifier", PlayerFunctions::luaPlayerGetCombatModifier);
	Lua::registerMethod(L, "Player", "setCombatModifier", PlayerFunctions::luaPlayerSetCombatModifier);
	Lua::registerMethod(L, "Player", "getAmmo", PlayerFunctions::luaPlayerGetAmmo);
	Lua::registerMethod(L, "Player", "unlearnHabilidade", PlayerFunctions::luaPlayerUnlearnHabilidade);	
	Lua::registerMethod(L, "Player", "unlearnAllHabilidades", PlayerFunctions::luaPlayerUnlearnAllHabilidades);
	Lua::registerMethod(L, "Player", "learnHabilidadeBatch", PlayerFunctions::luaPlayerLearnHabilidadeBatch);
	Lua::registerMethod(L, "Player", "getVocationBaseMaxHealth", PlayerFunctions::luaPlayerGetVocationBaseMaxHealth);
	Lua::registerMethod(L, "Player", "getVocationBaseMaxMana", PlayerFunctions::luaPlayerGetVocationBaseMaxMana);
	Lua::registerMethod(L, "Player", "getNaturalSpeed", PlayerFunctions::luaPlayerGetNaturalSpeed);
	Lua::registerMethod(L, "Player", "setMovementSpeed", PlayerFunctions::luaPlayerSetMovementSpeed);
	Lua::registerMethod(L, "Player", "openRemoteContainer", PlayerFunctions::luaPlayerOpenRemoteContainer);
...
int PlayerFunctions::luaPlayerOpenRemoteContainer(lua_State* L) {
    // 1. Lê o jogador do Lua
    auto player = Lua::getUserdataShared<Player>(L, 1, "Player");
    // 2. Lê o container do Lua
    auto container = Lua::getUserdataShared<Container>(L, 2, "Container");
    ...
    // 3. Chama o método que abre o container remotamente
    player->openRemoteContainer(container);
    lua_pushboolean(L, true);
    return 1;
}

int PlayerFunctions::luaPlayerGetNaturalSpeed(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (!player) {
        lua_pushnil(L);
        return 1;
    }
    lua_pushnumber(L, player->getNaturalSpeed());
    return 1;
}

int PlayerFunctions::luaPlayerSetMovementSpeed(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (!player) return 0;
    int32_t speed = Lua::getNumber<int32_t>(L, 2);
    player->setMovementSpeed(speed);
    return 0;
}

int PlayerFunctions::luaPlayerGetVocationBaseMaxHealth(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (!player) {
        lua_pushnil(L);
        return 1;
    }
    lua_pushnumber(L, player->getVocationBaseMaxHealth());
    return 1;
}

int PlayerFunctions::luaPlayerGetVocationBaseMaxMana(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (!player) {
        lua_pushnil(L);
        return 1;
    }
    lua_pushnumber(L, player->getVocationBaseMaxMana());
    return 1;
}

int PlayerFunctions::luaPlayerUnlearnAllHabilidades(lua_State* L) {
    const auto &player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (!player) {
        lua_pushnil(L);
        return 1;
    }
    player->unlearnAllHabilidades();
    Lua::pushBoolean(L, true);
    return 1;
}

int PlayerFunctions::luaPlayerLearnHabilidadeBatch(lua_State* L) {
    const auto &player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (!player) {
        lua_pushnil(L);
        return 1;
    ...
    if (lua_istable(L, 2)) {
        lua_pushnil(L);  // primeiro valor para iteração
        while (lua_next(L, 2) != 0) {
            // valor no índice -1, chave no índice -2
            if (lua_isnumber(L, -1)) {
                ids.push_back(static_cast<uint16_t>(lua_tonumber(L, -1)));
            }
            lua_pop(L, 1); // remove o valor, mantém a chave para próxima iteração
        }
    }
    player->learnHabilidadeBatch(ids);
    Lua::pushBoolean(L, true);
    return 1;
}

int PlayerFunctions::luaPlayerUnlearnHabilidade(lua_State* L) {
    const auto &player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (!player) {
        lua_pushnil(L);
        return 1;
    }
    uint16_t habId = Lua::getNumber<uint16_t>(L, 2);
    player->unlearnHabilidade(habId);
    Lua::pushBoolean(L, true);
    return 1;
}

int PlayerFunctions::luaPlayerGetAmmo(lua_State* L) {
    const auto &player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (!player) {
        lua_pushnil(L);
        return 1;
    ...
    // 1. Tenta o slot de munição (CONST_SLOT_AMMO = 10)
    std::shared_ptr<Item> ammoItem = player->getInventoryItem(CONST_SLOT_AMMO);
    if (ammoItem) {
        Lua::pushUserdata<Item>(L, ammoItem);
        Lua::setItemMetatable(L, -1, ammoItem);
        return 1;
    }

    // 2. Procura um quiver (aljava) nos slots de mão
    for (auto slot : {CONST_SLOT_LEFT, CONST_SLOT_RIGHT}) {
        std::shared_ptr<Item> handItem = player->getInventoryItem(slot);
        if (handItem && handItem->getContainer()) {
            std::shared_ptr<Container> quiver = handItem->getContainer();
            if (quiver && !quiver->getItemList().empty()) {
                std::shared_ptr<Item> firstAmmo = quiver->getItemList().front();
                if (firstAmmo) {
                    Lua::pushUserdata<Item>(L, firstAmmo);
                    Lua::setItemMetatable(L, -1, firstAmmo);
                    return 1;
                }
            }
        }
...
int PlayerFunctions::luaPlayerGetCombatModifier(lua_State* L) {
    const auto &player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (!player) {
        lua_pushnil(L);
        return 1;
    }
    auto key = Lua::getString(L, 2);
    Lua::pushNumber(L, player->getCombatModifier(key));
    return 1;
}

int PlayerFunctions::luaPlayerSetCombatModifier(lua_State* L) {
    const auto &player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (!player) {
        return 0;
    }
    auto key = Lua::getString(L, 2);
    double value = Lua::getNumber<double>(L, 3);
    player->setCombatModifier(key, value);
    return 0;
}

// MCR – Storages em lote
int PlayerFunctions::luaPlayerGetStorages(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (!player) {
        lua_newtable(L);
        return 1;
    ...
    int n = lua_gettop(L);
    for (int i = 2; i <= n; ++i) {
        keys.push_back(Lua::getNumber<uint32_t>(L, i));
    }
    auto storages = player->getStorages(keys);
    lua_newtable(L);
...
int PlayerFunctions::luaPlayerSetStorages(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (!player) {
        return 0;
    }
    ...
    while (lua_next(L, 2) != 0) {
        ...
        int32_t value = Lua::getNumber<int32_t>(L, -1);
        data[key] = value;
        lua_pop(L, 1);
    }
    player->setStorages(data);
    return 0;
}

// MCR – Afinidades em lote
int PlayerFunctions::luaPlayerAddDominioAfinidadeBatch(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (!player) {
        return 0;
    }
    std::map<uint16_t, int32_t> data;
    lua_pushnil(L);
    while (lua_next(L, 2) != 0) {
        uint16_t dominioId = Lua::getNumber<uint16_t>(L, -2);
        int32_t pontos = Lua::getNumber<int32_t>(L, -1);
        data[dominioId] = pontos;
        lua_pop(L, 1);
    }
    player->addDominioAfinidadeBatch(data);
    return 0;
}

int PlayerFunctions::luaPlayerGetDominioAfinidades(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (!player) {
        lua_newtable(L);
        return 1;
    }
    std::vector<uint16_t> dominios;
    int n = lua_gettop(L);
    for (int i = 2; i <= n; ++i) {
        dominios.push_back(Lua::getNumber<uint16_t>(L, i));
    }
    auto afinidades = player->getDominioAfinidades(dominios);
    lua_newtable(L);
    for (const auto& [id, valor] : afinidades) {
        lua_pushnumber(L, id);
...
int PlayerFunctions::luaPlayerClearActionHistory(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (!player) {
        lua_pushnil(L);
        return 1;
...
// Player:getActionHistory(maxCount)
int PlayerFunctions::luaPlayerGetActionHistory(lua_State* L) {
    // Obtém o player do primeiro argumento
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (!player) {
        lua_pushnil(L);
        return 1;
    ...
    // Lê o número máximo de ações
    size_t maxCount = Lua::getNumber<size_t>(L, 2);

    // Chama o método C++
    std::vector<Player::SintoniaData> history = player->getActionHistory(maxCount);

    // Cria uma tabela Lua para devolver os resultados
    lua_newtable(L);
    int index = 1;
    for (size_t i = 0; i < history.size(); ++i) {
        lua_newtable(L);                      // cada entrada é uma sub-tabela

        // Adiciona "dominioId"
        lua_pushnumber(L, history[i].dominioId);
        lua_setfield(L, -2, "dominioId");

        // Adiciona "timestamp"
        lua_pushnumber(L, static_cast<lua_Number>(history[i].timestamp));
        lua_setfield(L, -2, "timestamp");

        lua_rawseti(L, -2, index++);          // insere a sub-tabela na tabela principal
    }

    return 1;  // retorna a tabela
}

// Função auxiliar para obter shared_ptr<Player> da stack Lua
static std::shared_ptr<Player> getPlayerFromLua(lua_State* L, int index) {
    // A userdata armazena um ponteiro para shared_ptr<Player>
    auto ptr = static_cast<std::shared_ptr<Player>*>(lua_touserdata(L, index));
    if (!ptr) {
        luaL_error(L, "Expected Player object");
    }
    return *ptr;
}

int PlayerFunctions::luaPlayerGetDominioState(lua_State* L) {
    auto player = getPlayerFromLua(L, 1);
    uint16_t dominioId = static_cast<uint16_t>(luaL_checknumber(L, 2));
    uint8_t state = player->getDominioState(dominioId);
    lua_pushnumber(L, state);
    return 1;
}

int PlayerFunctions::luaPlayerSetDominioState(lua_State* L) {
    auto player = getPlayerFromLua(L, 1);
    uint16_t dominioId = static_cast<uint16_t>(luaL_checknumber(L, 2));
    uint8_t state = static_cast<uint8_t>(luaL_checknumber(L, 3));
    player->setDominioState(dominioId, state);
    return 0;
}

// Opcional: getAllActiveStates (se o C++ já suportar)
int PlayerFunctions::luaPlayerGetAllActiveStates(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (!player) {
        lua_newtable(L);
        return 1;
    ...
    lua_newtable(L);
    if (player->activeStates && player->activeStatesReady) {
        try {
            for (const auto& [domId, state] : *player->activeStates) {
                lua_pushnumber(L, domId);
                lua_pushnumber(L, state);
                lua_settable(L, -3);
            }
        } catch (...) {
            // Silencia qualquer exceção residual
        }
    }
    return 1;
}

int PlayerFunctions::luaPlayerGetDamageTakenModifier(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        lua_pushnumber(L, player->getDamageTakenModifier());
    } else {
        lua_pushnil(L);
    }
    return 1;
...
int PlayerFunctions::luaPlayerSetDamageTakenModifier(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        float mod = Lua::getNumber<float>(L, 2);
        player->setDamageTakenModifier(mod);
        Lua::pushBoolean(L, true);
    } else {
        lua_pushnil(L);
    }
...
int PlayerFunctions::luaPlayerSetLifeLeechModifier(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        player->setLifeLeechModifier(Lua::getNumber<float>(L, 2));
        Lua::pushBoolean(L, true);
    } else {
        lua_pushnil(L);
    }
...
int PlayerFunctions::luaPlayerGetLifeLeechModifier(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        lua_pushnumber(L, player->getLifeLeechModifier());
    } else {
        lua_pushnil(L);
    }
    return 1;
...
int PlayerFunctions::luaPlayerSetManaLeechModifier(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        player->setManaLeechModifier(Lua::getNumber<float>(L, 2));
        Lua::pushBoolean(L, true);
    } else {
        lua_pushnil(L);
    }
...
int PlayerFunctions::luaPlayerGetManaLeechModifier(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        lua_pushnumber(L, player->getManaLeechModifier());
    } else {
        lua_pushnil(L);
    }
    return 1;
...
int PlayerFunctions::luaPlayerSetCanPushCreatures(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        player->setCanPushCreatures(Lua::getBoolean(L, 2));
        Lua::pushBoolean(L, true);
    } else {
        lua_pushnil(L);
    }
...
int PlayerFunctions::luaPlayerCanPushCreatures(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        Lua::pushBoolean(L, player->canPushCreatures());
    } else {
        lua_pushnil(L);
    }
    return 1;
...
int PlayerFunctions::luaPlayerSetStealth(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        bool stealth = Lua::getBoolean(L, 2);
...
int PlayerFunctions::luaPlayerIsStealth(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        Lua::pushBoolean(L, player->isStealth());
    } else {
        lua_pushnil(L);
    }
    return 1;
...
int PlayerFunctions::luaPlayerGetRangeModifier(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        lua_pushnumber(L, player->getRangeModifier());
    } else {
        lua_pushnil(L);
    }
    return 1;
...
int PlayerFunctions::luaPlayerSetRangeModifier(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        player->setRangeModifier(Lua::getNumber<int32_t>(L, 2));
        Lua::pushBoolean(L, true);
    } else {
        lua_pushnil(L);
    }
...
int PlayerFunctions::luaPlayerGetHealthRegenTicksModifier(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        lua_pushnumber(L, player->getHealthRegenTicksModifier());
    } else {
        lua_pushnil(L);
    }
    return 1;
...
int PlayerFunctions::luaPlayerSetHealthRegenTicksModifier(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        float mod = Lua::getNumber<float>(L, 2);
        player->setHealthRegenTicksModifier(mod);
        Lua::pushBoolean(L, true);
    } else {
        lua_pushnil(L);
    }
...
int PlayerFunctions::luaPlayerGetManaRegenTicksModifier(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        lua_pushnumber(L, player->getManaRegenTicksModifier());
    } else {
        lua_pushnil(L);
    }
    return 1;
...
int PlayerFunctions::luaPlayerSetManaRegenTicksModifier(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        float mod = Lua::getNumber<float>(L, 2);
        player->setManaRegenTicksModifier(mod);
        Lua::pushBoolean(L, true);
    } else {
        lua_pushnil(L);
    }
...
int PlayerFunctions::luaPlayerGetHealthRegenModifier(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        lua_pushnumber(L, player->getHealthRegenModifier());
    } else {
        lua_pushnil(L);
    }
    return 1;
...
int PlayerFunctions::luaPlayerSetHealthRegenModifier(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        float mod = Lua::getNumber<float>(L, 2);
        player->setHealthRegenModifier(mod);
        Lua::pushBoolean(L, true);
    } else {
        lua_pushnil(L);
    }
...
int PlayerFunctions::luaPlayerGetDominioAfinidade(lua_State* L) {
	// player:getDominioAfinidade(dominioId)
	const auto &player = Lua::getUserdataShared<Player>(L, 1, "Player");
	if (!player) {
		lua_pushnil(L);
		return 1;
	}
	const uint16_t dominioId = Lua::getNumber<uint16_t>(L, 2);
	lua_pushnumber(L, player->getDominioAfinidade(dominioId));
	return 1;
}

int PlayerFunctions::luaPlayerAddDominioAfinidade(lua_State* L) {
	// player:addDominioAfinidade(dominioId, amount)
	const auto &player = Lua::getUserdataShared<Player>(L, 1, "Player");
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	const uint16_t dominioId = Lua::getNumber<uint16_t>(L, 2);
	const int32_t amount = Lua::getNumber<int32_t>(L, 3);
	player->addDominioAfinidade(dominioId, amount);
	Lua::pushBoolean(L, true);
	return 1;
}

int PlayerFunctions::luaPlayerSetDominioDespertado(lua_State* L) {
	// player:setDominioDespertado(dominioId, despertado)
	const auto &player = Lua::getUserdataShared<Player>(L, 1, "Player");
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	const uint16_t dominioId = Lua::getNumber<uint16_t>(L, 2);
	const bool despertado = Lua::getBoolean(L, 3);
	player->setDominioDespertado(dominioId, despertado);
	Lua::pushBoolean(L, true);
	return 1;
}

int PlayerFunctions::luaPlayerHasHabilidade(lua_State* L) {
	// player:hasHabilidade(habilidadeId)
	const auto &player = Lua::getUserdataShared<Player>(L, 1, "Player");
	if (!player) {
		lua_pushnil(L);
		return 1;
	}
	const uint16_t habilidadeId = Lua::getNumber<uint16_t>(L, 2);
	Lua::pushBoolean(L, player->hasHabilidade(habilidadeId));
	return 1;
}

int PlayerFunctions::luaPlayerLearnHabilidade(lua_State* L) {
	// player:learnHabilidade(habilidadeId)
	const auto &player = Lua::getUserdataShared<Player>(L, 1, "Player");
	if (!player) {
		lua_pushnil(L);
		return 1;
...
int PlayerFunctions::luaPlayerRegisterDominioAction(lua_State* L) {
...
// velocidade de ataque dinamica
int PlayerFunctions::luaPlayerGetAttackSpeedModifier(lua_State* L) {
    const auto &player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        lua_pushnumber(L, player->getAttackSpeedModifier());
    } else {
        lua_pushnil(L);
    }
    return 1;
...
int PlayerFunctions::luaPlayerSetAttackSpeedModifier(lua_State* L) {
    const auto &player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        float mod = Lua::getNumber<float>(L, 2);
        player->setAttackSpeedModifier(mod);
        Lua::pushBoolean(L, true);
    } else {
        lua_pushnil(L);
    }
...
int PlayerFunctions::luaPlayerGetManaRegenModifier(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        lua_pushnumber(L, player->getManaRegenModifier());
    } else {
        lua_pushnil(L);
    }
    return 1;
...
int PlayerFunctions::luaPlayerSetManaRegenModifier(lua_State* L) {
    const auto& player = Lua::getUserdataShared<Player>(L, 1, "Player");
    if (player) {
        float mod = Lua::getNumber<float>(L, 2);
        player->setManaRegenModifier(mod);
        Lua::pushBoolean(L, true);
    } else {
        lua_pushnil(L);
    }
