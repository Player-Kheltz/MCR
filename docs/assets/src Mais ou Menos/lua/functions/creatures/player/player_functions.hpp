...
class PlayerFunctions {
	...
	static int luaPlayerGetDominioAfinidade(lua_State* L);
	static int luaPlayerAddDominioAfinidade(lua_State* L);
	static int luaPlayerSetDominioDespertado(lua_State* L);
	static int luaPlayerHasHabilidade(lua_State* L);
	static int luaPlayerLearnHabilidade(lua_State* L);

	// MCR – Sintonia Natural
	static int luaPlayerRegisterDominioAction(lua_State* L);

	// MCR – Velocidade de ataque dinamica
	static int luaPlayerGetAttackSpeedModifier(lua_State* L);
	static int luaPlayerSetAttackSpeedModifier(lua_State* L);

	// MCR – Regeneração de Vida e Mana dinamica
	static int luaPlayerGetManaRegenModifier(lua_State* L);
	static int luaPlayerSetManaRegenModifier(lua_State* L);
	static int luaPlayerGetHealthRegenModifier(lua_State* L);
	static int luaPlayerSetHealthRegenModifier(lua_State* L);
	static int luaPlayerGetHealthRegenTicksModifier(lua_State* L);
	static int luaPlayerSetHealthRegenTicksModifier(lua_State* L);
	static int luaPlayerGetManaRegenTicksModifier(lua_State* L);
	static int luaPlayerSetManaRegenTicksModifier(lua_State* L);

	// MCR – Range Dinamica
	static int luaPlayerGetRangeModifier(lua_State* L);
	static int luaPlayerSetRangeModifier(lua_State* L);

	// MCR – Stealth Dinamico (furtividade)
	static int luaPlayerSetStealth(lua_State* L);
	static int luaPlayerIsStealth(lua_State* L);

	// MCR – Posturas de Combate
	static int luaPlayerSetCanPushCreatures(lua_State* L);
	static int luaPlayerCanPushCreatures(lua_State* L);

	// MCR - Vida e Mana Leech
	static int luaPlayerSetLifeLeechModifier(lua_State* L);
	static int luaPlayerGetLifeLeechModifier(lua_State* L);
	static int luaPlayerSetManaLeechModifier(lua_State* L);
	static int luaPlayerGetManaLeechModifier(lua_State* L);

	// MCR - Dano Recebido Dinamico
	static int luaPlayerGetDamageTakenModifier(lua_State* L);
	static int luaPlayerSetDamageTakenModifier(lua_State* L);

	static int luaPlayerGetDominioState(lua_State* L);
	static int luaPlayerSetDominioState(lua_State* L);
	static int luaPlayerGetAllActiveStates(lua_State* L);
	static int luaPlayerGetActionHistory(lua_State* L);
	static int luaPlayerClearActionHistory(lua_State* L);
	static int luaPlayerGetStorages(lua_State* L);
	static int luaPlayerSetStorages(lua_State* L);
	static int luaPlayerAddDominioAfinidadeBatch(lua_State* L);
	static int luaPlayerGetDominioAfinidades(lua_State* L);
	static int luaPlayerGetCombatModifier(lua_State* L);
	static int luaPlayerSetCombatModifier(lua_State* L);
	static int luaPlayerGetAmmo(lua_State* L);
	static int luaPlayerUnlearnHabilidade(lua_State* L);
	static int luaPlayerUnlearnAllHabilidades(lua_State* L);
	static int luaPlayerLearnHabilidadeBatch(lua_State* L);
	static int luaPlayerGetVocationBaseMaxHealth(lua_State* L);
	static int luaPlayerGetVocationBaseMaxMana(lua_State* L);
	static int luaPlayerGetNaturalSpeed(lua_State* L);
	static int luaPlayerSetMovementSpeed(lua_State* L);
	static int luaPlayerOpenRemoteContainer(lua_State* L);
