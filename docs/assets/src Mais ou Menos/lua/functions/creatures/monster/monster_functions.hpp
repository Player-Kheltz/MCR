...
private:
	...
	static int luaMonsterCreateInventory(lua_State* L);
	static int luaMonsterAddItemToInventory(lua_State* L);
	static int luaMonsterGetInventoryContainer(lua_State* L);
