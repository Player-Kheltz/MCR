...
private:
	...
	// MCR – Funções Lua para atributos de itens
	static int luaItemGetElementalBond(lua_State* L);
	static int luaItemGetMagicLevelPoints(lua_State* L);
	static int luaItemGetSkillFist(lua_State* L);
	static int luaItemGetSkillSword(lua_State* L);
	static int luaItemGetSkillAxe(lua_State* L);
	static int luaItemGetSkillClub(lua_State* L);
	static int luaItemGetSkillDistance(lua_State* L);
	static int luaItemGetSkillShield(lua_State* L);
	static int luaItemGetCriticalHitChance(lua_State* L);
	static int luaItemGetCriticalHitDamage(lua_State* L);
	static int luaItemGetLifeLeechAmount(lua_State* L);
	static int luaItemGetLifeLeechChance(lua_State* L);
	static int luaItemGetManaLeechAmount(lua_State* L);
	static int luaItemGetManaLeechChance(lua_State* L);
	static int luaItemGetReflectDamage(lua_State* L);
	static int luaItemGetShootType(lua_State* L);
	...
	static int luaItemGetSpeed(lua_State* L);
	static int luaItemGetHealthGain(lua_State* L);
	static int luaItemGetManaGain(lua_State* L);
	static int luaItemGetTransformEquipTo(lua_State* L);
	static int luaItemGetSlotPosition(lua_State* L);
	static int luaItemIsStackable(lua_State* L);
	static int luaItemIsFluidContainer(lua_State* L);
	static int luaItemGetWeaponType(lua_State* L);
	static int luaItemGetLightLevel(lua_State* L);
	static int luaItemGetLightColor(lua_State* L);
	static int luaItemGetDecayTo(lua_State* L);
	static int luaItemGetDecayTime(lua_State* L);
	static int luaItemIsShowDuration(lua_State* L);
	static int luaItemGetAmmoType(lua_State* L);
	static int luaItemGetElementType(lua_State* L);	
