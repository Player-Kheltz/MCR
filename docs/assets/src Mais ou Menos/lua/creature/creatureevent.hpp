...
public:
    ...
    // Novos eventos MCR
    void executeOnSpell(const std::shared_ptr<Player>& player, const std::string& spellName) const;
    void executeOnItemUse(const std::shared_ptr<Player>& player, const std::shared_ptr<Item>& item) const;
    void executeDealtDamage(const std::shared_ptr<Player>& attacker, const std::shared_ptr<Creature>& target, int32_t damage, CombatType_t primaryType, CombatType_t secondaryType);
    void executeOnFightModeChange(const std::shared_ptr<Player>& player, FightMode_t oldMode, FightMode_t newMode) const;
    void executeOnDominioAction(const std::shared_ptr<Player>& player, uint16_t dominioId) const;
...
public:
    ...
    // Novos disparadores MCR
    void playerSpell(const std::shared_ptr<Player>& player, const std::string& spellName) const;
    void playerItemUse(const std::shared_ptr<Player>& player, const std::shared_ptr<Item>& item) const;
    void playerOnDealtDamage(const std::shared_ptr<Player>& attacker, const std::shared_ptr<Creature>& target, int32_t damage, CombatType_t primaryType, CombatType_t secondaryType) const;
    void playerOnFightModeChange(const std::shared_ptr<Player>& player, FightMode_t oldMode, FightMode_t newMode) const;
    void playerDominioAction(const std::shared_ptr<Player>& player, uint16_t dominioId) const;
