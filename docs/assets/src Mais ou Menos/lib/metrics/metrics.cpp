...
void Metrics::init(Options opts) {
	...
	if (opts.enablePrometheusExporter) {
		g_logger().info("Iniciando o exportador Prometheus em {}", opts.prometheusOptions.url);
