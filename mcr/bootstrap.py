...
_DOMINIOS = {
    ...
    'kernel': [
        'devia.kernel.mcr_kernel.engine',
        'devia.kernel.mcr_kernel.decisor',
        'devia.kernel.mcr_kernel.signature',
        'devia.kernel.mcr_kernel.memory',
        'devia.kernel.mcr_kernel.meta',
        'devia.kernel.mcr_kernel.evolution',
        'devia.kernel.mcr_kernel.feedback',
        'devia.kernel.mcr_kernel.persistence',
        'devia.kernel.mcr_kernel.state',
        'devia.kernel.mcr_kernel.system',
    ],
    'modules': [
